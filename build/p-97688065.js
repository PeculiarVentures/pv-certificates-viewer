 ...
 */
import{h as e}from"./p-0b356bb5.js";import{a1 as a,$ as n,a0 as t,a2 as c,a6 as o,v as s,a7 as r,a8 as i,a9 as f,aa as u,ab as l,ac as d,ad as b,ae as m,af as v,ag as x,ah as p,ai as g,aj as y,ak as h,al as C,am as N,an as S,ao as A,ap as D,aq as I,ar as j,as as T,at as G,au as O,av as P,aw as L,ax as k,ay as R,az as V,aA as $,aB as B,aC as E,aD as U,aE as K,a3 as H,aF as M,aG as X,aH as Y,aI as q,aJ as w,aK as z,aL as F,aM as Q,aN as W,aO as J}from"./p-74c241e7.js";import{b as _}from"./p-a053c132.js";import{T as Z,B as ee}from"./p-7f9beaa8.js";import{D as ae}from"./p-17e3c47b.js";
/**
 * @license
 ...
 */function ne(e){const n=a[e];if(n){return`${n} (${e})`}return e}
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const te=e=>`https://search.gleif.org/#/record/${e}`;const ce=e=>`https://search.censys.io/search?resource=hosts&q=dns.names%3A${e}`;const oe=e=>`https://search.censys.io/search?resource=hosts&q=ip%3A${e}`
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */;function se(e){return e.indexOf("http")===0}
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const re=(a,n)=>{const{href:t,variant:c}=a;return e(Z,{component:"a",variant:c,color:"secondary",href:t,target:"_blank",rel:"noreferrer noopener"},n)};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const ie=(a,n)=>e("tr",null,e("td",{colSpan:2},e("table",null,n)));const fe=a=>{const{value:n}=a;if(!n){return null}return[e("tr",{class:"title"},e("td",{colSpan:2},e(Z,{variant:"s1",color:"black"},n))),e("tr",null,e("td",{colSpan:2,class:"divider"},e("span",null)))]};const ue=a=>{const{name:n,value:t,monospace:c,collapse:o,href:s,extraValue:r}=a;if(!n){return null}if(t===undefined||t===null){return null}let i;if(o){i=e("peculiar-text-hider",null,t)}else{i=t}const f=!!t.toString();return e("tr",null,e("td",{colSpan:f?1:2},e(Z,{variant:"b2",color:"gray-9"},n)),f&&e("td",{class:{monospace:c}},se(t.toString())||s?e(re,{variant:"b2",href:s||t.toString()},t):e(Z,{variant:"b2",color:"black"},i,r)))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const xe=a=>{const{name:t,issuerDnLink:c}=a;const o=n.getString("issuerName");return[e(fe,{value:c?e(re,{href:c},o):o}),t.map((a=>e(ue,{name:a.name||a.type,value:a.value})))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const pe=a=>{const{signature:t}=a;if(!t){return null}function c(a){return[e(ue,{name:n.getString("algorithm"),value:ne(a.algorithm)}),e(ue,{name:n.getString("value"),value:_.Convert.ToHex(a.value),monospace:true,collapse:true})]}return[e(fe,{value:n.getString("signature")}),c(t),t.params&&t.params.length&&t.params.map((a=>e(ie,null,c(a))))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const ye=(a,t)=>{const{extension:c}=a;return[e(ue,{name:"Name",value:ne(c.asn.extnID)}),e(ue,{name:"Critical",value:c.asn.critical?n.getString("yes"):n.getString("no")}),t,e("tr",null,e("td",{colSpan:2,class:"divider"},e("span",null)))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ne=a=>{const{extension:n}=a;return e(ye,{extension:n},Boolean(n.value.length)&&[e(ue,{name:"Purposes",value:""}),n.value.map((a=>e(ie,null,e(ue,{name:"Purpose",value:ne(a)}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Se=a=>{const{extension:n,getSubjectKeyIdChildrenLink:t,getSubjectKeyIdSiblingsLink:c}=a;const o=_.Convert.ToHex(n.value.buffer);const s=t(o);const r=c(o);return e(ye,{extension:n},e(ue,{name:"Key ID",value:o,monospace:true,extraValue:[s&&e("span",null," [",e(re,{href:s},"children"),"]"),r&&e("span",null," [",e(re,{href:r},"siblings"),"]")]}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ae=a=>{const{extension:n,getAuthKeyIdParentLink:t,getAuthKeyIdSiblingsLink:c}=a;const o=_.Convert.ToHex(n.value.keyIdentifier.buffer);const s=t(o);const r=c(o);return e(ye,{extension:n},e(ue,{name:"Key ID",value:o,monospace:true,extraValue:[s&&e("span",null," [",e(re,{href:s},"parents"),"]"),r&&e("span",null," [",e(re,{href:r},"siblings"),"]")]}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Te=a=>{const{extension:n}=a;return e(ye,{extension:n},Boolean(n.value.length)&&[e(ue,{name:"Descriptions",value:""}),n.value.map((n=>e(ie,null,e(ue,{name:"Method",value:ne(n.accessMethod)}),e(Ie,Object.assign({generalName:n.accessLocation},a)))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */;const ea=a=>{const{extension:n}=a;function t(a,n){if(!n.byteLength){return null}if(a===x){const a=s.parse(n,p);return e(ue,{name:"Semantics Identifier",value:ne(a.semanticsIdentifier)})}if(a===Ze){const a=s.parse(n,Fe);return e(ue,{name:"QC Types",value:a.map((e=>ne(e))).join(", ")})}if(a===Je){const a=s.parse(n,Ye);return e(ue,{name:"Retention Period",value:`${a.value} years`})}if(a===_e){const a=s.parse(n,we);return[e(ue,{name:"PDS Locations",value:""}),a.map((a=>e(ie,null,e(ue,{name:"URL",value:a.url}),e(ue,{name:"Language",value:a.language}))))]}return e(ue,{name:"Info",value:_.Convert.ToHex(n),monospace:true})}return e(ye,{extension:n},Boolean(n.value.length)&&[e(ue,{name:"Statements",value:""}),n.value.map((a=>e(ie,null,e(ue,{name:"Statement ID",value:ne(a.statementId)}),t(a.statementId,a.statementInfo))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function ia(e){return _.Convert.ToString(e.values[0])}
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const fa=a=>{const{extension:n}=a;return e(ye,{extension:n},Boolean(n.value.length)&&[e(ue,{name:"Attributes",value:""}),n.value.map((a=>e(ie,null,e(ue,{name:"Type",value:ne(a.type)}),e(ue,{name:"Value",value:ia(a)}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const pa=a=>{const{extension:n}=a;return e(ye,{extension:n},n.value.map(((a,n)=>[e(ue,{name:`Policy #${n+1}`,value:""}),e(ue,{name:"Issuer Domain",value:ne(a.issuerDomainPolicy)}),e(ue,{name:"Subject Domain",value:ne(a.subjectDomainPolicy)})])))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ca=a=>{const{certificate:t}=a;return[e(fe,{value:n.getString("miscellaneous")}),e("tr",null,e("td",null,e(ee,{onClick:()=>t.downloadAsPEM(),startIcon:e(ae,null)},n.getString("download.pem")))),e("tr",null,e("td",null,e(ee,{onClick:()=>t.downloadAsDER(),startIcon:e(ae,null)},n.getString("download.der"))))]};export{le as B,ha as E,Ie as G,xe as I,Ca as M,me as P,ue as R,pe as S,ie as T,fe as a,ge as b,te as c,ce as d,oe as e,ve as f,ne as g};
//# sourceMappingURL=p-97688065.js.map