 ...
 */
import{h as e}from"./p-CwgZaF40.js";import{$ as n,Z as a,_ as t,b as c,bn as o,bo as s,q as r,bp as i,bq as f,br as u,bs as l,bt as b,bu as d,bv as m,bw as v,bx as p,by as x,bz as g,bA as y,bB as h,bC as C,bD as S,au as N,aE as D,ay as A,ao as I,aF as j,aB as O,aG as T,a8 as G,aq as k,aC as L,at as P,am as B,al as R,ai as V,an as U,ak as $,aj as E,ag as K,ah as q,af as w,ae as H,az as M,ap as X,ad as F,ac as Y,ab as z,aa as Z,a9 as Q,as as W,ar as _,a7 as J,aA as ee,a5 as ne,a4 as ae}from"./p-DlZsmFQf.js";import{L as te}from"./p-DMZr5ztF.js";import{C as ce}from"./p-D_iUymDX.js";import{T as oe,B as se}from"./p-CutTi-2B.js";import{D as re}from"./p-JyD6URnB.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const De=n=>{const{thumbprints:t}=n;if(!t){return null}const c=Object.keys(t);if(!c.length){return null}return[e(ve,{value:a.getString("fingerprints")}),c.map((n=>e(pe,{name:n,value:t[n],monospace:true})))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ae=(n,t)=>{const{extension:c}=n;return[e(pe,{name:"Name",value:ie(c.asn.extnID)}),e(pe,{name:"Critical",value:c.asn.critical?a.getString("yes"):a.getString("no")}),t,e("tr",null,e("td",{colSpan:2,class:"divider"},e("span",null)))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ie=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Usage",value:a.value.toJSON().join(", ")}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const je=n=>{const{extension:t}=n;return e(Ae,{extension:t},e(pe,{name:"Certificate Authority",value:t.value.cA?a.getString("yes"):a.getString("no")}),e(pe,{name:"Path Length Constraint",value:t.value.pathLenConstraint}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Oe=n=>{const{extension:a}=n;return e(Ae,{extension:a},Boolean(a.value.length)&&[e(pe,{name:"Purposes",value:""}),a.value.map((n=>e(me,null,e(pe,{name:"Purpose",value:ie(n)}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Te=n=>{const{extension:a,getSubjectKeyIdChildrenLink:t,getSubjectKeyIdSiblingsLink:o}=n;const s=c.Convert.ToHex(a.value.buffer);const r=t(s);const i=o(s);return e(Ae,{extension:a},e(pe,{name:"Key ID",value:s,monospace:true,extraValue:[r&&e("span",null," [",e(te,{href:r},"children"),"]"),i&&e("span",null," [",e(te,{href:i},"siblings"),"]")]}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ge=n=>{const{extension:a,getAuthKeyIdParentLink:t,getAuthKeyIdSiblingsLink:o}=n;const s=c.Convert.ToHex(a.value.keyIdentifier.buffer);const r=t(s);const i=o(s);return e(Ae,{extension:a},e(pe,{name:"Key ID",value:s,monospace:true,extraValue:[r&&e("span",null," [",e(te,{href:r},"parents"),"]"),i&&e("span",null," [",e(te,{href:i},"siblings"),"]")]}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Pe=n=>{const{extension:a}=n;return e(Ae,{extension:a},a.value.map((a=>{var t,c;return[(t=a.distributionPoint)===null||t===void 0?void 0:t.fullName.map((a=>e(Le,Object.assign({generalName:a},n)))),(c=a.cRLIssuer)===null||c===void 0?void 0:c.map((a=>e(Le,Object.assign({generalName:a},n))))]})))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Be=n=>{const{extension:a}=n;return e(Ae,{extension:a},Boolean(a.value.length)&&[e(pe,{name:"Descriptions",value:""}),a.value.map((a=>e(me,null,e(pe,{name:"Method",value:ie(a.accessMethod)}),e(Le,Object.assign({generalName:a.accessLocation},n)))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Re=n=>{const{extension:a}=n;return e(Ae,{extension:a},a.value.map((a=>e(Le,Object.assign({generalName:a},n)))))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const $e=n=>{const{extension:a}=n;return e(Ae,{extension:a},Boolean(a.value.items.length)&&[e(pe,{name:"Signed Certificate Timestamps",value:""}),a.value.toJSON().map((n=>e(me,null,e(pe,{name:"Version",value:n.version+1}),e(pe,{name:"Log Operator",value:Ue[n.logId]||n.logId}),e(pe,{name:"Log Key ID",value:n.logId,monospace:true}),e(pe,{name:"Timestamp",value:t(n.timestamp)}),e(pe,{name:"Signature Algorithm",value:`${n.hashAlgorithm} ${n.signatureAlgorithm}`.toUpperCase()}),e(pe,{name:"Signature",value:n.signature,monospace:true}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ee=n=>{var a,t;const{extension:c}=n;return e(Ae,{extension:c},(a=c.value.excludedSubtrees)===null||a===void 0?void 0:a.map((a=>e(Le,Object.assign({generalName:a.base},n)))),(t=c.value.permittedSubtrees)===null||t===void 0?void 0:t.map((a=>e(Le,Object.assign({generalName:a.base},n)))))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ke=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Template ID",value:a.value.templateID}),e(pe,{name:"Template Major Version",value:a.value.templateMajorVersion}),e(pe,{name:"Template Minor Version",value:a.value.templateMinorVersion}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const qe=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Name",value:a.value.toString()}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const we=n=>{const{extension:a}=n;const t=a.value.getVersion();return e(Ae,{extension:a},e(pe,{name:"Certificate Index",value:t.certificateIndex}),e(pe,{name:"Key Index",value:t.keyIndex}))};var He,Me,Xe,Fe;let Ye=class e{constructor(e){if(typeof e==="string"){this.alphabetic=e}else if(typeof e==="number"){this.numeric=e}}};l([b({type:d.PrintableString})],Ye.prototype,"alphabetic",void 0);l([b({type:d.PrintableString})],Ye.prototype,"numeric",void 0);Ye=l([m({type:v.Choice})],Ye);class ze{constructor(e={}){this.currency=new Ye;this.amount=0;this.exponent=0;Object.assign(this,e)}}l([b({type:Ye})],ze.prototype,"currency",void 0);l([b({type:d.Integer})],ze.prototype,"amount",void 0);l([b({type:d.Integer})],ze.prototype,"exponent",void 0);let Ze=class e extends ze{};Ze=l([m({type:v.Sequence})],Ze);let Qe=class e{constructor(e=0){this.value=e}};l([b({type:d.Integer})],Qe.prototype,"value",void 0);Qe=l([m({type:v.Choice})],Qe);let We=class e{constructor(e={}){this.url="";this.language="";Object.assign(this,e)}};l([b({type:d.IA5String})],We.prototype,"url",void 0);l([b({type:d.PrintableString})],We.prototype,"language",void 0);We=l([m({type:v.Sequence})],We);let _e=He=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,He.prototype)}};_e=He=l([m({type:v.Sequence,itemType:We})],_e);let Je=Me=class e extends _e{constructor(e){super(e);Object.setPrototypeOf(this,Me.prototype)}};Je=Me=l([m({type:v.Sequence,itemType:We})],Je);let en=Xe=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Xe.prototype)}};en=Xe=l([m({type:v.Sequence,itemType:d.ObjectIdentifier})],en);let nn=Fe=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Fe.prototype)}};nn=Fe=l([m({type:v.Sequence,itemType:d.PrintableString})],nn);const an="0.4.0.1862.1";const tn=`${an}.3`;const cn=`${an}.5`;const on=`${an}.6`
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */;const sn=n=>{const{extension:a}=n;function t(n,a){if(!a.byteLength){return null}if(n===x){const n=r.parse(a,g);return e(pe,{name:"Semantics Identifier",value:ie(n.semanticsIdentifier)})}if(n===on){const n=r.parse(a,en);return e(pe,{name:"QC Types",value:n.map((e=>ie(e))).join(", ")})}if(n===tn){const n=r.parse(a,Qe);return e(pe,{name:"Retention Period",value:`${n.value} years`})}if(n===cn){const n=r.parse(a,_e);return[e(pe,{name:"PDS Locations",value:""}),n.map((n=>e(me,null,e(pe,{name:"URL",value:n.url}),e(pe,{name:"Language",value:n.language}))))]}return e(pe,{name:"Info",value:c.Convert.ToHex(a),monospace:true})}return e(Ae,{extension:a},Boolean(a.value.length)&&[e(pe,{name:"Statements",value:""}),a.value.map((n=>e(me,null,e(pe,{name:"Statement ID",value:ie(n.statementId)}),t(n.statementId,n.statementInfo))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const rn=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Comment",value:a.value.value}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const fn=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Type",value:a.value.toJSON().join(", ")}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const un=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Role",value:a.value.text}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const ln=n=>{const{extension:a,getLEILink:t}=n;return e(Ae,{extension:a},e(pe,{name:"Identifier",value:a.value.text,href:t(a.value.text)}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const bn=n=>{const{extension:t}=n;return e(Ae,{extension:t},e(pe,{name:"Version",value:t.value.version}),e(Le,Object.assign({generalName:t.value.location},n)),e(pe,{name:"Requires Auth",value:t.value.requiresAuth?a.getString("yes"):a.getString("no")}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const dn=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Version",value:a.value.version}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const mn=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Reason",value:a.value.toJSON()}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const pn=n=>{const{extension:a}=n;return e(Ae,{extension:a},Boolean(a.value.length)&&[e(pe,{name:"Attributes",value:""}),a.value.map((n=>e(me,null,e(pe,{name:"Type",value:ie(n.type)}),e(pe,{name:"Value",value:vn(n)}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const xn=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Value",value:a.value,monospace:true}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const gn=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Not Before",value:t(a.value.notBefore)}),e(pe,{name:"Not After",value:t(a.value.notAfter)}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const yn=n=>{const{extension:a}=n;return e(Ae,{extension:a},e(pe,{name:"Version",value:a.value.entrustVers}),e(pe,{name:"Info Flags",value:a.value.entrustInfoFlags.toJSON().join(", ")}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Sn=n=>{const{extension:a}=n;return e(Ae,{extension:a},a.value.length>0&&[e(pe,{name:"Entries",value:""}),a.value.map((n=>e(me,null,e(pe,{name:"SPC",value:n.spc}),e(pe,{name:"Range",value:n.range?`start=${n.range.start} count==${n.range.count}`:null}),e(pe,{name:"One",value:n.one}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Nn=n=>{const{extension:a}=n;return e(Ae,{extension:a},a.value.requireExplicitPolicy&&e(pe,{name:"Require Explicit Policy",value:y.toASN(a.value.requireExplicitPolicy).valueBlock.toString()}),a.value.inhibitPolicyMapping&&e(pe,{name:"Inhibit Policy Mapping",value:y.toASN(a.value.inhibitPolicyMapping).valueBlock.toString()}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Dn=n=>{const{extension:a}=n;return e(Ae,{extension:a},a.value.length>0&&[e(pe,{name:"Policies",value:""}),a.value.map((n=>e(me,null,e(pe,{name:"Issuer Domain",value:ie(n.issuerDomainPolicy)}),e(pe,{name:"Subject Domain",value:ie(n.subjectDomainPolicy)}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const An=n=>{const{extension:t}=n;return e(Ae,{extension:t},e(pe,{name:a.getString("value"),value:t.value.value}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const On=n=>{const{extension:a}=n;return e(Ae,{extension:a},Object.keys(a.value).map((n=>e(pe,{name:fe(n),value:a.value[n]}))))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Tn=n=>{const{extensions:a,title:t}=n;if(!a||!a.length){return null}return[e(ve,{value:t||"Extensions"}),a.map((a=>{try{if(a.value instanceof N){return e(Ie,{extension:a})}if(a.value instanceof D){return e(je,{extension:a})}if(a.value instanceof A){return e(Oe,{extension:a})}if(a.value instanceof I){return e(Te,Object.assign({extension:a},n))}if(a.value instanceof j){return e(Ge,Object.assign({extension:a},n))}if(a.value instanceof O){return e(Pe,Object.assign({extension:a},n))}if(a.value instanceof T||a.value instanceof G){return e(Be,Object.assign({extension:a},n))}if(a.value instanceof k){return e(Re,Object.assign({extension:a},n))}if(a.value instanceof L){return e(Ve,{extension:a})}if(a.value instanceof ce){return e($e,{extension:a})}if(a.value instanceof P){return e(Ee,Object.assign({extension:a},n))}if(a.value instanceof B){return e(Ke,{extension:a})}if(a.value instanceof R){return e(qe,{extension:a})}if(a.value instanceof V){return e(we,{extension:a})}if(a.value instanceof U){return e(sn,{extension:a})}if(a.value instanceof $){return e(rn,{extension:a})}if(a.value instanceof E){return e(fn,{extension:a})}if(a.value instanceof K){return e(un,{extension:a})}if(a.value instanceof q){return e(ln,Object.assign({extension:a},n))}if(a.value instanceof w){return e(bn,Object.assign({extension:a},n))}if(a.value instanceof H){return e(dn,{extension:a})}if(a.value instanceof M){return e(mn,{extension:a})}if(a.value instanceof X){return e(pn,{extension:a})}if(a.value instanceof F){return e(gn,{extension:a})}if(a.value instanceof Y){return e(yn,{extension:a})}if(a.value instanceof z){return e(hn,{extension:a})}if(a.value instanceof Z){return e(Cn,{extension:a})}if(a.value instanceof Q){return e(Sn,{extension:a})}if(a.value instanceof W){return e(Nn,{extension:a})}if(a.value instanceof _){return e(Dn,{extension:a})}if(a.value instanceof J){return e(An,{extension:a})}if(a.value instanceof ee){return e(In,Object.assign({extension:a},n))}if(a.value instanceof ne){return e(jn,Object.assign({extension:a},n))}if(a.value instanceof ae){return e(On,Object.assign({extension:a},n))}if(typeof a.value==="string"){return e(xn,{extension:a})}return e(Ae,{extension:a})}catch(e){console.error("Error render extension:",a.asn.extnID);return null}}))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Gn=n=>{const{certificate:t}=n;return[e(ve,{value:a.getString("miscellaneous")}),e("tr",null,e("td",null,e(se,{startIcon:e(re,null),onClick:()=>t.downloadAsPEM()},a.getString("download.pem")))),e("tr",null,e("td",null,e(se,{startIcon:e(re,null),onClick:()=>t.downloadAsDER()},a.getString("download.der"))))]};export{xe as B,Tn as E,Le as G,Se as I,Gn as M,he as P,pe as R,Ce as S,De as T,Ne as a,le as b,ue as c,ie as d,fe as e,me as f,be as g,ve as h};
//# sourceMappingURL=p-ChZOu3OR.js.map