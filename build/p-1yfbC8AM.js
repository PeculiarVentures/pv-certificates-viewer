 ...
 */
import{h as e}from"./p-Dpo1Lsuj.js";import{$ as n,Z as a,_ as t,b as c,bn as o,bo as s,q as r,bp as i,bq as f,br as u,bs as l,bt as b,bu as d,bv as m,bw as v,bx as p,by as x,bz as g,bA as y,bB as h,bC as C,bD as S,au as N,aE as A,ay as D,ao as I,aF as j,aB as O,aG as G,a8 as T,aq as L,aC as k,at as P,am as V,al as B,ai as R,an as E,ak as $,aj as U,ag as K,ah as q,af as H,ae as X,az as Y,ap as w,ad as M,ac as z,ab as F,aa as W,a9 as Q,as as Z,ar as _,a7 as J,aA as ee,a5 as ne,a4 as ae}from"./p-CmOVFH_Z.js";import{L as te}from"./p-BoVBJ09p.js";import{C as ce}from"./p-DXA1451q.js";import{T as oe,B as se}from"./p-GTlYmF1j.js";import{D as re}from"./p-DzEcDVLW.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const $e=n=>{const{extension:a}=n;return e(De,{extension:a},Boolean(a.value.items.length)&&[e(pe,{name:"Signed Certificate Timestamps",value:""}),a.value.toJSON().map((n=>e(me,null,e(pe,{name:"Version",value:n.version+1}),e(pe,{name:"Log Operator",value:Ee[n.logId]||n.logId}),e(pe,{name:"Log Key ID",value:n.logId,monospace:true}),e(pe,{name:"Timestamp",value:t(n.timestamp)}),e(pe,{name:"Signature Algorithm",value:`${n.hashAlgorithm} ${n.signatureAlgorithm}`.toUpperCase()}),e(pe,{name:"Signature",value:n.signature,monospace:true}),e(pe,{name:"Extensions",value:n.extensions||undefined,monospace:true}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const He=n=>{const{extension:a}=n;const t=a.value.getVersion();return e(De,{extension:a},e(pe,{name:"Certificate Index",value:t.certificateIndex}),e(pe,{name:"Key Index",value:t.keyIndex}))};var Xe,Ye,we,Me;let ze=class e{constructor(e){if(typeof e==="string"){this.alphabetic=e}else if(typeof e==="number"){this.numeric=e}}};l([b({type:d.PrintableString})],ze.prototype,"alphabetic",void 0);l([b({type:d.PrintableString})],ze.prototype,"numeric",void 0);ze=l([m({type:v.Choice})],ze);class Fe{constructor(e={}){this.currency=new ze;this.amount=0;this.exponent=0;Object.assign(this,e)}}l([b({type:ze})],Fe.prototype,"currency",void 0);l([b({type:d.Integer})],Fe.prototype,"amount",void 0);l([b({type:d.Integer})],Fe.prototype,"exponent",void 0);let We=class e extends Fe{};We=l([m({type:v.Sequence})],We);let Qe=class e{constructor(e=0){this.value=e}};l([b({type:d.Integer})],Qe.prototype,"value",void 0);Qe=l([m({type:v.Choice})],Qe);let Ze=class e{constructor(e={}){this.url="";this.language="";Object.assign(this,e)}};l([b({type:d.IA5String})],Ze.prototype,"url",void 0);l([b({type:d.PrintableString})],Ze.prototype,"language",void 0);Ze=l([m({type:v.Sequence})],Ze);let _e=Xe=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Xe.prototype)}};_e=Xe=l([m({type:v.Sequence,itemType:Ze})],_e);let Je=Ye=class e extends _e{constructor(e){super(e);Object.setPrototypeOf(this,Ye.prototype)}};Je=Ye=l([m({type:v.Sequence,itemType:Ze})],Je);let en=we=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,we.prototype)}};en=we=l([m({type:v.Sequence,itemType:d.ObjectIdentifier})],en);let nn=Me=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Me.prototype)}};nn=Me=l([m({type:v.Sequence,itemType:d.PrintableString})],nn);const an="0.4.0.1862.1";const tn=`${an}.3`;const cn=`${an}.5`;const on=`${an}.6`
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
...
//# sourceMappingURL=p-1yfbC8AM.js.map