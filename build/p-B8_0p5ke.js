 ...
 */
import{h as e}from"./p-CwgZaF40.js";import{$ as n,Z as a,_ as t,b as c,bn as o,bo as s,q as r,bp as i,bq as f,br as u,bs as l,bt as b,bu as d,bv as m,bw as v,bx as p,by as x,bz as g,bA as y,bB as h,bC as C,bD as S,au as N,aE as A,ay as D,ao as I,aF as j,aB as O,aG as T,a8 as G,aq as k,aC as L,at as P,am as B,al as R,ai as V,an as $,ak as E,aj as U,ag as K,ah as q,af as w,ae as H,az as M,ap as z,ad as X,ac as Y,ab as F,aa as Z,a9 as Q,as as W,ar as J,a7 as _,aA as ee,a5 as ne,a4 as ae}from"./p-rmToyzuK.js";import{L as te}from"./p-DMZr5ztF.js";import{C as ce}from"./p-BtqN4pgo.js";import{T as oe,B as se}from"./p-CutTi-2B.js";import{D as re}from"./p-JyD6URnB.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const we=n=>{const{extension:a}=n;const t=a.value.getVersion();return e(De,{extension:a},e(pe,{name:"Certificate Index",value:t.certificateIndex}),e(pe,{name:"Key Index",value:t.keyIndex}))};var He,Me,ze,Xe;let Ye=class e{constructor(e){if(typeof e==="string"){this.alphabetic=e}else if(typeof e==="number"){this.numeric=e}}};l([b({type:d.PrintableString})],Ye.prototype,"alphabetic",void 0);l([b({type:d.PrintableString})],Ye.prototype,"numeric",void 0);Ye=l([m({type:v.Choice})],Ye);class Fe{constructor(e={}){this.currency=new Ye;this.amount=0;this.exponent=0;Object.assign(this,e)}}l([b({type:Ye})],Fe.prototype,"currency",void 0);l([b({type:d.Integer})],Fe.prototype,"amount",void 0);l([b({type:d.Integer})],Fe.prototype,"exponent",void 0);let Ze=class e extends Fe{};Ze=l([m({type:v.Sequence})],Ze);let Qe=class e{constructor(e=0){this.value=e}};l([b({type:d.Integer})],Qe.prototype,"value",void 0);Qe=l([m({type:v.Choice})],Qe);let We=class e{constructor(e={}){this.url="";this.language="";Object.assign(this,e)}};l([b({type:d.IA5String})],We.prototype,"url",void 0);l([b({type:d.PrintableString})],We.prototype,"language",void 0);We=l([m({type:v.Sequence})],We);let Je=He=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,He.prototype)}};Je=He=l([m({type:v.Sequence,itemType:We})],Je);let _e=Me=class e extends Je{constructor(e){super(e);Object.setPrototypeOf(this,Me.prototype)}};_e=Me=l([m({type:v.Sequence,itemType:We})],_e);let en=ze=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,ze.prototype)}};en=ze=l([m({type:v.Sequence,itemType:d.ObjectIdentifier})],en);let nn=Xe=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Xe.prototype)}};nn=Xe=l([m({type:v.Sequence,itemType:d.PrintableString})],nn);const an="0.4.0.1862.1";const tn=`${an}.3`;const cn=`${an}.5`;const on=`${an}.6`
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
...
//# sourceMappingURL=p-B8_0p5ke.js.map