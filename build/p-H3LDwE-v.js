 ...
 */
import{h as e}from"./p-Dpo1Lsuj.js";import{a6 as n,a4 as a,a5 as t,b as c,bn as o,bo as s,q as r,bp as i,bq as f,br as u,bs as l,bt as b,bu as d,bv as m,bw as v,bx as p,by as x,bz as g,bA as y,bB as h,bC as C,bD as S,aA as N,aK as A,aE as D,au as I,aL as j,aH as O,aM as G,ae as T,aw as L,aI as k,az as P,as as V,ar as B,ao as E,at as R,aq as $,ap as U,am as K,an as H,al as q,ak as w,aF as M,av as W,aj as X,ai as Y,ah as z,ag as F,af as Q,ay as J,ax as Z,ad as _,aG as ee,ab as ne,aa as ae}from"./p-W3NjaQ7X.js";import{L as te}from"./p-BoVBJ09p.js";import{C as ce}from"./p-CLH6WW-E.js";import{T as oe,B as se}from"./p-GTlYmF1j.js";import{D as re}from"./p-DzEcDVLW.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ge=n=>{const{extension:a,getSubjectKeyIdChildrenLink:t,getSubjectKeyIdSiblingsLink:o}=n;const s=c.Convert.ToHex(a.value.buffer);const r=t(s);const i=o(s);return e(De,{extension:a},e(pe,{name:"Key ID",value:s,monospace:true,extraValue:[r&&e("span",null," [",e(te,{href:r},"children"),"]"),i&&e("span",null," [",e(te,{href:i},"siblings"),"]")]}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Pe=n=>{const{extension:a}=n;return e(De,{extension:a},a.value.map((a=>{var t,c;return[(t=a.distributionPoint)===null||t===void 0?void 0:t.fullName.map((a=>e(ke,Object.assign({generalName:a},n)))),(c=a.cRLIssuer)===null||c===void 0?void 0:c.map((a=>e(ke,Object.assign({generalName:a},n))))]})))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ve=n=>{const{extension:a}=n;return e(De,{extension:a},Boolean(a.value.length)&&[e(pe,{name:"Descriptions",value:""}),a.value.map((a=>e(me,null,e(pe,{name:"Method",value:ie(a.accessMethod)}),e(ke,Object.assign({generalName:a.accessLocation},n)))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Be=n=>{const{extension:a}=n;return e(De,{extension:a},a.value.map((a=>e(ke,Object.assign({generalName:a},n)))))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const $e=n=>{const{extension:a}=n;return e(De,{extension:a},Boolean(a.value.items.length)&&[e(pe,{name:"Signed Certificate Timestamps",value:""}),a.value.toJSON().map((n=>e(me,null,e(pe,{name:"Version",value:n.version+1}),e(pe,{name:"Log Operator",value:Re[n.logId]||n.logId}),e(pe,{name:"Log Key ID",value:n.logId,monospace:true}),e(pe,{name:"Timestamp",value:t(n.timestamp)}),e(pe,{name:"Signature Algorithm",value:`${n.hashAlgorithm} ${n.signatureAlgorithm}`.toUpperCase()}),e(pe,{name:"Signature",value:n.signature,monospace:true}),e(pe,{name:"Extensions",value:n.extensions||undefined,monospace:true}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ue=n=>{var a,t;const{extension:c}=n;return e(De,{extension:c},(a=c.value.excludedSubtrees)===null||a===void 0?void 0:a.map((a=>e(ke,Object.assign({generalName:a.base},n)))),(t=c.value.permittedSubtrees)===null||t===void 0?void 0:t.map((a=>e(ke,Object.assign({generalName:a.base},n)))))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const He=n=>{const{extension:a}=n;return e(De,{extension:a},e(pe,{name:"Name",value:a.value.toString()}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const qe=n=>{const{extension:a}=n;const t=a.value.getVersion();return e(De,{extension:a},e(pe,{name:"Certificate Index",value:t.certificateIndex}),e(pe,{name:"Key Index",value:t.keyIndex}))};var we,Me,We,Xe;let Ye=class e{constructor(e){if(typeof e==="string"){this.alphabetic=e}else if(typeof e==="number"){this.numeric=e}}};l([b({type:d.PrintableString})],Ye.prototype,"alphabetic",void 0);l([b({type:d.PrintableString})],Ye.prototype,"numeric",void 0);Ye=l([m({type:v.Choice})],Ye);class ze{constructor(e={}){this.currency=new Ye;this.amount=0;this.exponent=0;Object.assign(this,e)}}l([b({type:Ye})],ze.prototype,"currency",void 0);l([b({type:d.Integer})],ze.prototype,"amount",void 0);l([b({type:d.Integer})],ze.prototype,"exponent",void 0);let Fe=class e extends ze{};Fe=l([m({type:v.Sequence})],Fe);let Qe=class e{constructor(e=0){this.value=e}};l([b({type:d.Integer})],Qe.prototype,"value",void 0);Qe=l([m({type:v.Choice})],Qe);let Je=class e{constructor(e={}){this.url="";this.language="";Object.assign(this,e)}};l([b({type:d.IA5String})],Je.prototype,"url",void 0);l([b({type:d.PrintableString})],Je.prototype,"language",void 0);Je=l([m({type:v.Sequence})],Je);let Ze=we=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,we.prototype)}};Ze=we=l([m({type:v.Sequence,itemType:Je})],Ze);let _e=Me=class e extends Ze{constructor(e){super(e);Object.setPrototypeOf(this,Me.prototype)}};_e=Me=l([m({type:v.Sequence,itemType:Je})],_e);let en=We=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,We.prototype)}};en=We=l([m({type:v.Sequence,itemType:d.ObjectIdentifier})],en);let nn=Xe=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Xe.prototype)}};nn=Xe=l([m({type:v.Sequence,itemType:d.PrintableString})],nn);const an="0.4.0.1862.1";const tn=`${an}.3`;const cn=`${an}.5`;const on=`${an}.6`
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */;const sn=n=>{const{extension:a}=n;function t(n,a){if(!a||!a.byteLength){return null}if(n===x){const n=r.parse(a,g);return e(pe,{name:"Semantics Identifier",value:ie(n.semanticsIdentifier)})}if(n===on){const n=r.parse(a,en);return e(pe,{name:"QC Types",value:n.map((e=>ie(e))).join(", ")})}if(n===tn){const n=r.parse(a,Qe);return e(pe,{name:"Retention Period",value:`${n.value} years`})}if(n===cn){const n=r.parse(a,Ze);return[e(pe,{name:"PDS Locations",value:""}),n.map((n=>e(me,null,e(pe,{name:"URL",value:n.url}),e(pe,{name:"Language",value:n.language}))))]}return e(pe,{name:"Info",value:c.Convert.ToHex(a),monospace:true})}return e(De,{extension:a},Boolean(a.value.length)&&[e(pe,{name:"Statements",value:""}),a.value.map((n=>e(me,null,e(pe,{name:"Statement ID",value:ie(n.statementId)}),t(n.statementId,n.statementInfo))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const bn=n=>{const{extension:t}=n;return e(De,{extension:t},e(pe,{name:"Version",value:t.value.version}),e(ke,Object.assign({generalName:t.value.location},n)),e(pe,{name:"Requires Auth",value:t.value.requiresAuth?a.getString("yes"):a.getString("no")}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Gn=n=>{const{extensions:a,title:t}=n;if(!a||!a.length){return null}return[e(ve,{value:t||"Extensions"}),a.map((a=>{try{if(a.value instanceof N){return e(Ie,{extension:a})}if(a.value instanceof A){return e(je,{extension:a})}if(a.value instanceof D){return e(Oe,{extension:a})}if(a.value instanceof I){return e(Ge,Object.assign({extension:a},n))}if(a.value instanceof j){return e(Te,Object.assign({extension:a},n))}if(a.value instanceof O){return e(Pe,Object.assign({extension:a},n))}if(a.value instanceof G||a.value instanceof T){return e(Ve,Object.assign({extension:a},n))}if(a.value instanceof L){return e(Be,Object.assign({extension:a},n))}if(a.value instanceof k){return e(Ee,{extension:a})}if(a.value instanceof ce){return e($e,{extension:a})}if(a.value instanceof P){return e(Ue,Object.assign({extension:a},n))}if(a.value instanceof V){return e(Ke,{extension:a})}if(a.value instanceof B){return e(He,{extension:a})}if(a.value instanceof E){return e(qe,{extension:a})}if(a.value instanceof R){return e(sn,{extension:a})}if(a.value instanceof $){return e(rn,{extension:a})}if(a.value instanceof U){return e(fn,{extension:a})}if(a.value instanceof K){return e(un,{extension:a})}if(a.value instanceof H){return e(ln,Object.assign({extension:a},n))}if(a.value instanceof q){return e(bn,Object.assign({extension:a},n))}if(a.value instanceof w){return e(dn,{extension:a})}if(a.value instanceof M){return e(mn,{extension:a})}if(a.value instanceof W){return e(pn,{extension:a})}if(a.value instanceof X){return e(gn,{extension:a})}if(a.value instanceof Y){return e(yn,{extension:a})}if(a.value instanceof z){return e(hn,{extension:a})}if(a.value instanceof F){return e(Cn,{extension:a})}if(a.value instanceof Q){return e(Sn,{extension:a})}if(a.value instanceof J){return e(Nn,{extension:a})}if(a.value instanceof Z){return e(An,{extension:a})}if(a.value instanceof _){return e(Dn,{extension:a})}if(a.value instanceof ee){return e(In,Object.assign({extension:a},n))}if(a.value instanceof ne){return e(jn,Object.assign({extension:a},n))}if(a.value instanceof ae){return e(On,Object.assign({extension:a},n))}if(typeof a.value==="string"){return e(xn,{extension:a})}return e(De,{extension:a})}catch(e){console.error("Error render extension:",a.asn.extnID);return null}}))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Tn=n=>{const{certificate:t}=n;return[e(ve,{value:a.getString("miscellaneous")}),e("tr",null,e("td",null,e(se,{startIcon:e(re,null),onClick:()=>t.downloadAsPEM()},a.getString("download.pem")))),e("tr",null,e("td",null,e(se,{startIcon:e(re,null),onClick:()=>t.downloadAsDER()},a.getString("download.der"))))]};export{xe as B,Gn as E,ke as G,Se as I,Tn as M,he as P,pe as R,Ce as S,Ae as T,Ne as a,le as b,ue as c,ie as d,fe as e,me as f,be as g,ve as h};
//# sourceMappingURL=p-H3LDwE-v.js.map