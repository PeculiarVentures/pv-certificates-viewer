 ...
 */
import{h as e}from"./p-Dpo1Lsuj.js";import{a6 as n,a4 as a,a5 as t,b as c,bn as o,bo as s,q as r,bp as i,bq as f,br as u,bs as l,bt as b,bu as d,bv as m,bw as v,bx as p,by as x,bz as g,bA as y,bB as h,bC as C,bD as S,aA as N,aK as A,aE as D,au as I,aL as j,aH as O,aM as T,ae as G,aw as L,aI as k,az as P,as as V,ar as B,ao as R,at as E,aq as $,ap as U,am as K,an as q,al as H,ak as w,aF as M,av as Y,aj as X,ai as z,ah as F,ag as Q,af as W,ay as Z,ax as J,ad as _,aG as ee,ab as ne,aa as ae}from"./p-Dxkusr7u.js";import{L as te}from"./p-BoVBJ09p.js";import{C as ce}from"./p-CQVTZZNu.js";import{T as oe,B as se}from"./p-GTlYmF1j.js";import{D as re}from"./p-DzEcDVLW.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const He=n=>{const{extension:a}=n;const t=a.value.getVersion();return e(De,{extension:a},e(pe,{name:"Certificate Index",value:t.certificateIndex}),e(pe,{name:"Key Index",value:t.keyIndex}))};var we,Me,Ye,Xe;let ze=class e{constructor(e){if(typeof e==="string"){this.alphabetic=e}else if(typeof e==="number"){this.numeric=e}}};l([b({type:d.PrintableString})],ze.prototype,"alphabetic",void 0);l([b({type:d.PrintableString})],ze.prototype,"numeric",void 0);ze=l([m({type:v.Choice})],ze);class Fe{constructor(e={}){this.currency=new ze;this.amount=0;this.exponent=0;Object.assign(this,e)}}l([b({type:ze})],Fe.prototype,"currency",void 0);l([b({type:d.Integer})],Fe.prototype,"amount",void 0);l([b({type:d.Integer})],Fe.prototype,"exponent",void 0);let Qe=class e extends Fe{};Qe=l([m({type:v.Sequence})],Qe);let We=class e{constructor(e=0){this.value=e}};l([b({type:d.Integer})],We.prototype,"value",void 0);We=l([m({type:v.Choice})],We);let Ze=class e{constructor(e={}){this.url="";this.language="";Object.assign(this,e)}};l([b({type:d.IA5String})],Ze.prototype,"url",void 0);l([b({type:d.PrintableString})],Ze.prototype,"language",void 0);Ze=l([m({type:v.Sequence})],Ze);let Je=we=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,we.prototype)}};Je=we=l([m({type:v.Sequence,itemType:Ze})],Je);let _e=Me=class e extends Je{constructor(e){super(e);Object.setPrototypeOf(this,Me.prototype)}};_e=Me=l([m({type:v.Sequence,itemType:Ze})],_e);let en=Ye=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Ye.prototype)}};en=Ye=l([m({type:v.Sequence,itemType:d.ObjectIdentifier})],en);let nn=Xe=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Xe.prototype)}};nn=Xe=l([m({type:v.Sequence,itemType:d.PrintableString})],nn);const an="0.4.0.1862.1";const tn=`${an}.3`;const cn=`${an}.5`;const on=`${an}.6`
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
...
//# sourceMappingURL=p-CxjH3MO5.js.map