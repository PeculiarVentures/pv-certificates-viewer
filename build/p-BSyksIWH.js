 ...
 */
import{h as n}from"./p-Dpo1Lsuj.js";import{x as e,v as t,w as r,e as l}from"./p-GpGk-vbe.js";import{L as u}from"./p-BoVBJ09p.js";import{T as a,B as o}from"./p-GTlYmF1j.js";import{D as s}from"./p-DzEcDVLW.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function b(n){if(n.params&&"modulus"in n.params){let e=n.params.modulus.byteLength;if(e%2){e-=1}return e*8}return null}function h(n){if(n.params&&"publicExponent"in n.params){return n.params.publicExponent.byteLength===3?65537:3}return null}const y=e=>{const{publicKey:r}=e;if(!r){return null}function u(e){return[n(p,{name:t.getString("algorithm"),value:i(e.algorithm)}),n(p,{name:t.getString("namedCurve"),value:i(e.params&&"namedCurve"in e.params?e.params.namedCurve:undefined)}),n(p,{name:t.getString("exponent"),value:h(e)}),n(p,{name:t.getString("modulus"),value:b(e)}),n(p,{name:t.getString("value"),value:l.Convert.ToHex(e.value),monospace:true,collapse:true})]}return[n(f,{value:t.getString("publicKeyInfo")}),u(r),Array.isArray(r.params)&&r.params.length&&r.params.map((e=>n(v,null,u(e))))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
