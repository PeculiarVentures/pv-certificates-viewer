...
const CertificatesViewer = class {
        ...
        return this.certificatesDecoded.map(certificate => {
            ...
            return ([
                h("tr", { class: {
                    ...
                    }, onClick: this.onClickRow.bind(this, certificate.serialNumber), key: certificate.serialNumber }, !this.isHasRoots && (h("td", { class: "b3 stroke_border" }, h("span", { class: "mobile_title text_grey align-left b3" }, "Issuer:"), h("span", { class: "content" }, certificate.issuer && certificate.issuer.CN ? certificate.issuer.CN.value : ''))), h("td", { class: "b3 stroke_border" }, h("span", { class: "mobile_title text_grey align-left b3" }, "Name:"), h("span", { class: "content" }, certificate.commonName)), h("td", { class: "b3 stroke_border" }, h("span", { class: "mobile_title text_grey align-left b3" }, "Public Key:"), h("span", { class: "content" }, certificate.publicKey.algorithm.name, " ", certificate.publicKey.algorithm.modulusBits || certificate.publicKey.algorithm.namedCurve)), h("td", { class: "b3 stroke_border" }, h("span", { class: "mobile_title text_grey align-left b3" }, "Fingerprint (SHA-1):"), h("span", { class: "content monospace" }, certificate.fingerprint)), h("td", { class: "align-center stroke_border" }, h("span", { class: "mobile_title text_grey align-left b3" }, "Actions:"), h("span", { class: "content" }, h("pv-button", { onClick: this.onClickDetails.bind(this, certificate.base64), class: "button_table_action" }, "Details"), h("pv-button-split", { onClick: this.onClickDownload.bind(this, certificate, 'PEM'), actions: [{
                            text: 'Download DER',
    ...
    render() {
        return (h(Host, null, h("table", { class: {
                text_black: true,
