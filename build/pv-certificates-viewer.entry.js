...
import { C as Certificate } from './index-e30070e7.js';
...
const CertificatesViewer = class {
    ...
    renderExpandedRow(certificate) {
        return (h("tr", { class: "expanded_summary fill_grey_1_opacity" }, h("td", { colSpan: 4, class: "stroke_grey_3_border" }, h("pv-certificate-summary", { certificate: certificate, showIssuer: !certificate.isRoot }))));
    }
    ...
    render() {
        return (h(Host, null, h("table", { class: "text_black" }, h("thead", { class: "fill_grey_2" }, h("tr", null, h("th", { class: "h7 stroke_grey_3_border" }, "Subject"), h("th", { class: "h7 stroke_grey_3_border" }, "Fingerprint (SHA-1)"), h("th", { class: "align-center h7 stroke_grey_3_border" }, "Actions"), h("th", { class: "align-center h7 stroke_grey_3_border" }, "Test URLs"))), h("tbody", null, this.renderCertificates())), this.renderCertificateDetailsModal()));
    }
