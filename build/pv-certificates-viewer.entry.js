...
const CertificatesViewer = class {
    ...
    render() {
        return (h(Host, null, h("table", { class: "text_black" }, h("thead", { class: "fill_grey_2" }, h("tr", null, h("th", { class: "h7 stroke_grey_3_border" }, "Name"), h("th", { class: "h7 stroke_grey_3_border" }, "Fingerprint (SHA-1)"), h("th", { class: "align-center h7 stroke_grey_3_border" }, "Actions"), h("th", { class: "align-center h7 stroke_grey_3_border" }, "Test URLs"))), h("tbody", null, this.renderCertificates())), this.renderCertificateDetailsModal()));
    }
