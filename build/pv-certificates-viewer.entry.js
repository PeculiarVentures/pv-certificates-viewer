...
const CertificatesViewer = class {
    ...
    renderExpandedRow(certificate) {
        ...
        return (h("tr", { class: "expanded_summary fill_grey_1_opacity" }, h("td", { colSpan: colSpan, class: "stroke_border" }, h("pv-certificate-summary", { certificate: certificate, showIssuer: !certificate.isRoot }))));
    }
