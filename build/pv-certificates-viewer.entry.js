...
import { C as Certificate } from './index-f29627c5.js';
...
const CertificatesViewer = class {
        ...
        this.certificatesDecoded.forEach((certificate) => {
            ...
            content.push([
                h("tr", { class: {
                    ...
                    }, onClick: this.onClickRow.bind(this, certificate.serialNumber), key: certificate.serialNumber }, !this.isHasRoots && (h("td", { class: "b3 stroke_border" }, h("span", { class: "mobile_title text_grey align-left b3" }, "Issuer:"), h("span", { class: "content" }, h("pv-highlight-words", { search: searchHighlight }, issuerValue)))), h("td", { class: "b3 stroke_border" }, h("span", { class: "mobile_title text_grey align-left b3" }, "Name:"), h("span", { class: "content" }, h("pv-highlight-words", { search: searchHighlight }, certificate.commonName))), h("td", { class: "b3 stroke_border" }, h("span", { class: "mobile_title text_grey align-left b3" }, "Public Key:"), h("span", { class: "content" }, h("pv-highlight-words", { search: searchHighlight }, publicKeyValue))), h("td", { class: "b3 stroke_border" }, h("span", { class: "mobile_title text_grey align-left b3" }, "Fingerprint (SHA-1):"), h("span", { class: "content monospace" }, h("pv-highlight-words", { search: searchHighlight }, certificate.fingerprint))), h("td", { class: "align-center stroke_border" }, h("span", { class: "mobile_title text_grey align-left b3" }, "Actions:"), h("span", { class: "content" }, h("pv-button", { onClick: this.onClickDetails.bind(this, certificate.base64), class: "button_table_action" }, "Details"), h("pv-button-split", { onClick: this.onClickDownload.bind(this, certificate, 'PEM'), actions: [{
                            text: 'Download DER',
    ...
    renderSearch() {
        ...
        return (h("div", { class: "search_section fill_grey_light stroke_border" }, h("input", { onInput: this.onSearchChange, type: "search", value: "", class: "input_search fill_white stroke_border text_black", disabled: !this.certificatesDecoded.length, placeholder: "Search" })));
    }
    renderEmptyState() {
