...
const CertificateSummary = class {
    ...
    renderCertificateSummary() {
        return (h("div", { class: {
            ...
            } }, h("div", { class: "basic_col" }, h("p", { class: "text_grey b3 dn_row" }, "Subject DN:"), this.renderDN(this.certificate.subject)), this.showIssuer && (h("div", { class: "basic_col stroke_border" }, h("p", { class: "text_grey b3 dn_row" }, "Issuer DN:"), this.renderDN(this.certificate.issuer))), h("div", { class: "basic_meta" }, this.renderMetaData(this.certificate))));
    }
    render() {
