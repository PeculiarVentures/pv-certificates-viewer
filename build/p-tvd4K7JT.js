 ...
 */
import{h as n}from"./p-Dpo1Lsuj.js";import{x as e,v as t,w as r,e as l}from"./p-PBNgg9AF.js";import{L as u}from"./p-BoVBJ09p.js";import{T as a,B as o}from"./p-GTlYmF1j.js";import{D as s}from"./p-DzEcDVLW.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var w=undefined&&undefined.__rest||function(n,e){var t={};for(var r in n)if(Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0)t[r]=n[r];if(n!=null&&typeof Object.getOwnPropertySymbols==="function")for(var l=0,r=Object.getOwnPropertySymbols(n);l<r.length;l++){if(e.indexOf(r[l])<0&&Object.prototype.propertyIsEnumerable.call(n,r[l]))t[r[l]]=n[r[l]]}return t};const B=e=>{const{extensions:t,title:r="Extensions"}=e,l=w(e,["extensions","title"]);if(!(t===null||t===void 0?void 0:t.length)){return null}return[n(f,{value:r}),t.map((e=>[n("tr",null,n("td",{colSpan:2},n(a,{variant:"s2",color:"gray-9"},i(e.oid)))),n(p,{name:"Critical",value:e.critical?"YES":"NO"}),e.children.map((n=>O(n,l))),n("tr",null,n("td",{colSpan:2,class:"divider"},n("span",null)))]))]};async function C(n){var e;n.setLoading(true);(e=n.onStart)===null||e===void 0?void 0:e.call(n);try{const e=await n.run();if(typeof e==="undefined"){return}await n.onSuccess(e)}catch(e){n.onError(e)}finally{n.setLoading(false)}}export{m as B,j as I,x as M,y as P,f as R,g as S,I as T,S as a,c as b,B as c,p as d,v as e,O as f,i as g,C as r};
//# sourceMappingURL=p-tvd4K7JT.js.map