 ...
 */
import{A as t,v as s,a0 as i,P as e,C as r,Q as n,G as a,y as o,F as h,D as c,a1 as u,N as l}from"./p-a0f46cc5.js";import{A as f}from"./p-6a8daf32.js";
/**
 * @license
 ...
 */class m extends t{constructor(t){var a;super(s(t),i);this.thumbprints={};this.type="X.509 Attribute Certificate";this.tag=e.AttributeCertificateTag;const{acinfo:o}=this.asn;this.serialNumber=r.ToHex(o.serialNumber);this.version=o.version;const h=o.attrCertValidityPeriod.notBeforeTime;if(!h){throw new Error("Cannot get 'notBefore' value")}this.notBefore=h;const c=o.attrCertValidityPeriod.notAfterTime;if(!c){throw new Error("Cannot get 'notAfter' value")}this.notAfter=c;this.validity=n(this.notBefore,this.notAfter);this.issuer=o.issuer.v1Form||((a=o.issuer.v2Form)===null||a===void 0?void 0:a.issuerName);this.holder=o.holder}get signature(){const{signatureValue:t,signatureAlgorithm:s}=this.asn;return{value:t,algorithm:s.algorithm}}parseExtensions(){const{acinfo:t}=this.asn;if(t.extensions){this.extensions=t.extensions.map((t=>new a(o.serialize(t))))}}parseAttributes(){const{acinfo:t}=this.asn;if(t.attributes){this.attributes=t.attributes.map((t=>new f(o.serialize(t))))}}async getThumbprint(t="SHA-1"){try{const s=await h(t,this.raw);if(s){this.thumbprints[t]=r.ToHex(s)}}catch(t){console.error("Error thumbprint get:",t)}}get commonName(){return`attribute-certificate-${this.thumbprints["SHA-1"]}`}toString(t="pem"){switch(t){case"pem":return e.encode(this.raw,this.tag);case"base64url":return r.ToBase64Url(this.raw);default:return r.ToBase64(this.raw)}}downloadAsPEM(t){c.attrCert.asPEM(this.toString("pem"),t||this.commonName)}downloadAsDER(t){c.attrCert.asDER(this.raw,t||this.commonName)}}
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
...
//# sourceMappingURL=p-f0402d47.js.map