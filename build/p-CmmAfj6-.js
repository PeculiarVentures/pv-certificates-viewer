 ...
 */
import{h as e}from"./p-DDDrq3In.js";import{_ as a,Y as n,Z as t,b as c,a5 as o,a9 as s,r,aa as i,ab as f,ac as u,ad as l,ae as d,af as b,ag as m,ah as v,ai as x,aj as p,ak as g,al as y,am as h,an as C,ao as N,ap as S,aq as A,ar as D,as as I,at as j,au as O,av as T,aw as G,ax as k,ay as L,az as P,aA as B,aB as V,aC as R,aD as E,aE as U,aF as $,aG as K,aH as H,aI as q,aJ as w,aK as M,a6 as X,aL as Y,aM as z,aN as Q,aO as W,aP as F,aQ as Z,aR as _,aS as J,aT as ee,aU as ae,aV as ne,aW as te}from"./p-DEDGNwdB.js";import{L as ce}from"./p-BisXzAqN.js";import{T as oe,B as se}from"./p-BCATfe_H.js";import{D as re}from"./p-BHBizfwo.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ne=a=>{const{name:t,issuerDnLink:c}=a;const o=n.getString("issuerName");return[e(ve,{value:c?e(ce,{href:c},o):o}),t.map((a=>e(xe,{name:a.name||a.type,value:a.value})))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Pe=a=>{const{extension:n}=a;return e(De,{extension:n},n.value.map((n=>{var t,c;return[(t=n.distributionPoint)===null||t===void 0?void 0:t.fullName.map((n=>e(Le,Object.assign({generalName:n},a)))),(c=n.cRLIssuer)===null||c===void 0?void 0:c.map((n=>e(Le,Object.assign({generalName:n},a))))]})))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Be=a=>{const{extension:n}=a;return e(De,{extension:n},Boolean(n.value.length)&&[e(xe,{name:"Descriptions",value:""}),n.value.map((n=>e(me,null,e(xe,{name:"Method",value:ie(n.accessMethod)}),e(Le,Object.assign({generalName:n.accessLocation},a)))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ve=a=>{const{extension:n}=a;return e(De,{extension:n},n.value.map((n=>e(Le,Object.assign({generalName:n},a)))))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ue=a=>{const{extension:n}=a;return e(De,{extension:n},Boolean(n.value.items.length)&&[e(xe,{name:"Signed Certificate Timestamps",value:""}),n.value.toJSON().map((a=>e(me,null,e(xe,{name:"Version",value:a.version+1}),e(xe,{name:"Log Operator",value:Ee[a.logId]||a.logId}),e(xe,{name:"Log Key ID",value:a.logId,monospace:true}),e(xe,{name:"Timestamp",value:t(a.timestamp)}),e(xe,{name:"Signature Algorithm",value:`${a.hashAlgorithm} ${a.signatureAlgorithm}`.toUpperCase()}),e(xe,{name:"Signature",value:a.signature,monospace:true}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const $e=a=>{var n,t;const{extension:c}=a;return e(De,{extension:c},(n=c.value.excludedSubtrees)===null||n===void 0?void 0:n.map((n=>e(Le,Object.assign({generalName:n.base},a)))),(t=c.value.permittedSubtrees)===null||t===void 0?void 0:t.map((n=>e(Le,Object.assign({generalName:n.base},a)))))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const He=a=>{const{extension:n}=a;return e(De,{extension:n},e(xe,{name:"Name",value:n.value.toString()}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const qe=a=>{const{extension:n}=a;const t=n.value.getVersion();return e(De,{extension:n},e(xe,{name:"Certificate Index",value:t.certificateIndex}),e(xe,{name:"Key Index",value:t.keyIndex}))};var we,Me,Xe,Ye;let ze=class e{constructor(e){if(typeof e==="string"){this.alphabetic=e}else if(typeof e==="number"){this.numeric=e}}};l([d({type:b.PrintableString})],ze.prototype,"alphabetic",void 0);l([d({type:b.PrintableString})],ze.prototype,"numeric",void 0);ze=l([m({type:v.Choice})],ze);class Qe{constructor(e={}){this.currency=new ze;this.amount=0;this.exponent=0;Object.assign(this,e)}}l([d({type:ze})],Qe.prototype,"currency",void 0);l([d({type:b.Integer})],Qe.prototype,"amount",void 0);l([d({type:b.Integer})],Qe.prototype,"exponent",void 0);let We=class e extends Qe{};We=l([m({type:v.Sequence})],We);let Fe=class e{constructor(e=0){this.value=e}};l([d({type:b.Integer})],Fe.prototype,"value",void 0);Fe=l([m({type:v.Choice})],Fe);let Ze=class e{constructor(e={}){this.url="";this.language="";Object.assign(this,e)}};l([d({type:b.IA5String})],Ze.prototype,"url",void 0);l([d({type:b.PrintableString})],Ze.prototype,"language",void 0);Ze=l([m({type:v.Sequence})],Ze);let _e=we=class e extends x{constructor(e){super(e);Object.setPrototypeOf(this,we.prototype)}};_e=we=l([m({type:v.Sequence,itemType:Ze})],_e);let Je=Me=class e extends _e{constructor(e){super(e);Object.setPrototypeOf(this,Me.prototype)}};Je=Me=l([m({type:v.Sequence,itemType:Ze})],Je);let ea=Xe=class e extends x{constructor(e){super(e);Object.setPrototypeOf(this,Xe.prototype)}};ea=Xe=l([m({type:v.Sequence,itemType:b.ObjectIdentifier})],ea);let aa=Ye=class e extends x{constructor(e){super(e);Object.setPrototypeOf(this,Ye.prototype)}};aa=Ye=l([m({type:v.Sequence,itemType:b.PrintableString})],aa);const na="0.4.0.1862.1";const ta=`${na}.3`;const ca=`${na}.5`;const oa=`${na}.6`
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const la=a=>{const{extension:t}=a;return e(De,{extension:t},e(xe,{name:"Version",value:t.value.version}),e(Le,Object.assign({generalName:t.value.location},a)),e(xe,{name:"Requires Auth",value:t.value.requiresAuth?n.getString("yes"):n.getString("no")}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Na=a=>{const{extension:n}=a;return e(De,{extension:n},n.value.requireExplicitPolicy&&e(xe,{name:"Require Explicit Policy",value:y.toASN(n.value.requireExplicitPolicy).valueBlock.toString()}),n.value.inhibitPolicyMapping&&e(xe,{name:"Inhibit Policy Mapping",value:y.toASN(n.value.inhibitPolicyMapping).valueBlock.toString()}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Sa=a=>{const{extension:n}=a;return e(De,{extension:n},n.value.length>0&&[e(xe,{name:"Policies",value:""}),n.value.map((a=>e(me,null,e(xe,{name:"Issuer Domain",value:ie(a.issuerDomainPolicy)}),e(xe,{name:"Subject Domain",value:ie(a.subjectDomainPolicy)}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ta=a=>{const{certificate:t}=a;return[e(ve,{value:n.getString("miscellaneous")}),e("tr",null,e("td",null,e(se,{onClick:()=>t.downloadAsPEM(),startIcon:e(re,null)},n.getString("download.pem")))),e("tr",null,e("td",null,e(se,{onClick:()=>t.downloadAsDER(),startIcon:e(re,null)},n.getString("download.der"))))]};export{pe as B,Oa as E,Le as G,Ne as I,Ta as M,he as P,xe as R,Ce as S,Ae as T,Se as a,le as b,ue as c,ie as d,fe as e,me as f,de as g,ve as h};
//# sourceMappingURL=p-CmmAfj6-.js.map