 ...
 */
import{h as n}from"./p-B0tLzdJT.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const c=(t,o)=>{const{href:c,class:e,startIcon:a,onClick:s}=t;const p=!!c;const l=p?"a":"button";return n(l,{type:!p&&"button",href:p&&c,target:p&&"_blank",rel:p&&"noreferrer noopener",class:{button:true,m_no_padding:o.length===0,[e]:Boolean(e)},onClick:s},a,o.length>0&&n(r,{variant:"b3",color:"black",component:"span"},o))};export{c as B,r as T};
//# sourceMappingURL=p-BNRN5kAu.js.map