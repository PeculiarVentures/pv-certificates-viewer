            ...
            ***************************************************************************** */
            ...
            var AttributeValue = /** @class */ (function (_super) {
                ...
                AttributeValue.prototype.toString = function () {
                    return this.ia5String || (this.anyValue ? Convert.ToHex(this.anyValue) : _super.prototype.toString.call(this));
                };
            ...
            var RelativeDistinguishedName = /** @class */ (function (_super) {
            ...
            var RDNSequence = /** @class */ (function (_super) {
            ...
            var Name = exports('N', /** @class */ (function (_super) {
            ...
            var GeneralNames = /** @class */ (function (_super) {
            ...
            var CertificateIssuer = /** @class */ (function (_super) {
            ...
            var DisplayText = exports('D', /** @class */ (function () {
            ...
            DisplayText = exports('D', __decorate([
                AsnType({ type: AsnTypeTypes.Choice })
            ], DisplayText));
            ...
            var IssueAlternativeName = /** @class */ (function (_super) {
                __extends(IssueAlternativeName, _super);
                function IssueAlternativeName() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
            ...
            var GeneralSubtrees = /** @class */ (function (_super) {
                __extends(GeneralSubtrees, _super);
                function GeneralSubtrees() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
            ...
            var SubjectDirectoryAttributes = /** @class */ (function (_super) {
            ...
            exports('S', SubjectKeyIdentifier);
            ...
            var OtherPrimeInfos = /** @class */ (function (_super) {
                __extends(OtherPrimeInfos, _super);
                function OtherPrimeInfos() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
            ...
            var dayjs_min = createCommonjsModule(function (module, exports) {
                ...
                } return new Date(e); }(t), this.init(); }, d.init = function () { var t = this.$d; this.$y = t.getFullYear(), this.$M = t.getMonth(), this.$D = t.getDate(), this.$W = t.getDay(), this.$H = t.getHours(), this.$m = t.getMinutes(), this.$s = t.getSeconds(), this.$ms = t.getMilliseconds(); }, d.$utils = function () { return D; }, d.isValid = function () { return !("Invalid Date" === this.$d.toString()); }, d.isSame = function (t, e) { var n = g(t); return this.startOf(e) <= n && n <= this.endOf(e); }, d.isAfter = function (t, e) { return g(t) < this.startOf(e); }, d.isBefore = function (t, e) { return this.endOf(e) < g(t); }, d.$g = function (t, e, n) { return D.u(t) ? this[e] : this.set(n, t); }, d.year = function (t) { return this.$g(t, "$y", o); }, d.month = function (t) { return this.$g(t, "$M", u); }, d.day = function (t) { return this.$g(t, "$W", i); }, d.date = function (t) { return this.$g(t, "$D", "date"); }, d.hour = function (t) { return this.$g(t, "$H", r); }, d.minute = function (t) { return this.$g(t, "$m", n); }, d.second = function (t) { return this.$g(t, "$s", e); }, d.millisecond = function (e) { return this.$g(e, "$ms", t); }, d.unix = function () { return Math.floor(this.valueOf() / 1e3); }, d.valueOf = function () { return this.$d.getTime(); }, d.startOf = function (t, a) { var h = this, f = !!D.u(a) || a, c = D.p(t), d = function (t, e) { var n = D.w(h.$u ? Date.UTC(h.$y, e, t) : new Date(h.$y, e, t), h); return f ? n : n.endOf(i); }, $ = function (t, e) { return D.w(h.toDate()[t].apply(h.toDate("s"), (f ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)), h); }, l = this.$W, m = this.$M, y = this.$D, M = "set" + (this.$u ? "UTC" : ""); switch (c) {
                    case o: return f ? d(1, 0) : d(31, 11);
                    case u: return f ? d(1, m) : d(0, m + 1);
                    case s:
                        var g = this.$locale().weekStart || 0, v = (l < g ? l + 7 : l) - g;
                        return d(f ? y - v : y + (6 - v), m);
                    case i:
                    case "date": return $(M + "Hours", 0);
                    case r: return $(M + "Minutes", 1);
                    case n: return $(M + "Seconds", 2);
                    case e: return $(M + "Milliseconds", 3);
                    default: return this.clone();
                } }, d.endOf = function (t) { return this.startOf(t, !1); }, d.$set = function (s, a) { var h, f = D.p(s), c = "set" + (this.$u ? "UTC" : ""), d = (h = {}, h[i] = c + "Date", h.date = c + "Date", h[u] = c + "Month", h[o] = c + "FullYear", h[r] = c + "Hours", h[n] = c + "Minutes", h[e] = c + "Seconds", h[t] = c + "Milliseconds", h)[f], $ = f === i ? this.$D + (a - this.$W) : a; if (f === u || f === o) {
                    var l = this.clone().set("date", 1);
                    l.$d[d]($), l.init(), this.$d = l.set("date", Math.min(this.$D, l.daysInMonth())).$d;
                }
                else
                    d && this.$d[d]($); return this.init(), this; }, d.set = function (t, e) { return this.clone().$set(t, e); }, d.get = function (t) { return this[D.p(t)](); }, d.add = function (t, a) { var h, f = this; t = Number(t); var c = D.p(a), d = function (e) { var n = g(f); return D.w(n.date(n.date() + Math.round(e * t)), f); }; if (c === u)
                    return this.set(u, this.$M + t); if (c === o)
                    return this.set(o, this.$y + t); if (c === i)
                    return d(1); if (c === s)
                    return d(7); var $ = (h = {}, h[n] = 6e4, h[r] = 36e5, h[e] = 1e3, h)[c] || 1, l = this.$d.getTime() + t * $; return D.w(l, this); }, d.subtract = function (t, e) { return this.add(-1 * t, e); }, d.format = function (t) { var e = this; if (!this.isValid())
                    return "Invalid Date"; var n = t || "YYYY-MM-DDTHH:mm:ssZ", r = D.z(this), i = this.$locale(), s = this.$H, u = this.$m, a = this.$M, o = i.weekdays, h = i.months, c = function (t, r, i, s) { return t && (t[r] || t(e, n)) || i[r].substr(0, s); }, d = function (t) { return D.s(s % 12 || 12, t, "0"); }, $ = i.meridiem || function (t, e, n) { var r = t < 12 ? "AM" : "PM"; return n ? r.toLowerCase() : r; }, l = { YY: String(this.$y).slice(-2), YYYY: this.$y, M: a + 1, MM: D.s(a + 1, 2, "0"), MMM: c(i.monthsShort, a, h, 3), MMMM: c(h, a), D: this.$D, DD: D.s(this.$D, 2, "0"), d: String(this.$W), dd: c(i.weekdaysMin, this.$W, o, 2), ddd: c(i.weekdaysShort, this.$W, o, 3), dddd: o[this.$W], H: String(s), HH: D.s(s, 2, "0"), h: d(1), hh: d(2), a: $(s, u, !0), A: $(s, u, !1), m: String(u), mm: D.s(u, 2, "0"), s: String(this.$s), ss: D.s(this.$s, 2, "0"), SSS: D.s(this.$ms, 3, "0"), Z: r }; return n.replace(f, function (t, e) { return e || l[t] || r.replace(":", ""); }); }, d.utcOffset = function () { return 15 * -Math.round(this.$d.getTimezoneOffset() / 15); }, d.diff = function (t, h, f) { var c, d = D.p(h), $ = g(t), l = 6e4 * ($.utcOffset() - this.utcOffset()), m = this - $, y = D.m(this, $); return y = (c = {}, c[o] = y / 12, c[u] = y, c[a] = y / 3, c[s] = (m - l) / 6048e5, c[i] = (m - l) / 864e5, c[r] = m / 36e5, c[n] = m / 6e4, c[e] = m / 1e3, c)[d] || m, f ? y : D.a(y); }, d.daysInMonth = function () { return this.endOf(u).$D; }, d.$locale = function () { return m[this.$L]; }, d.locale = function (t, e) { if (!t)
                    return this.$L; var n = this.clone(), r = M(t, e, !0); return r && (n.$L = r), n; }, d.clone = function () { return D.w(this.$d, this); }, d.toDate = function () { return new Date(this.valueOf()); }, d.toJSON = function () { return this.isValid() ? this.toISOString() : null; }, d.toISOString = function () { return this.$d.toISOString(); }, d.toString = function () { return this.$d.toUTCString(); }, c; }(); return g.prototype = v.prototype, g.extend = function (t, e) { return t(e, v, g), g; }, g.locale = M, g.isDayjs = y, g.unix = function (t) { return g(1e3 * t); }, g.en = m[l], g.Ls = m, g; });
            });
            var short = exports('s', function (date) { return (new Date(date).toUTCString()); });
            var diff = function (dateStart, dateEnd) {
            ...
            var validator = {
                isHex: function (value) { return /^\s*(?:[0-9A-Fa-f][0-9A-Fa-f]\s*)+$/
                    .test(value); },
                isPem: function (value) { return /-----BEGIN [^-]+-----([A-Za-z0-9+\/=\s]+)-----END [^-]+-----|begin-base64[^\n]+\n([A-Za-z0-9+\/=\s]+)====/
                    .test(value); },
                isBase64: function (value) { return /^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$/
                    .test(value); },
            };
            ...
            var BiometricSyntax = /** @class */ (function (_super) {
                __extends(BiometricSyntax, _super);
                function BiometricSyntax() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
            ...
            var NameRegistrationAuthorities = /** @class */ (function (_super) {
                __extends(NameRegistrationAuthorities, _super);
                function NameRegistrationAuthorities() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
            ...
            var QCStatements = exports('Q', /** @class */ (function (_super) {
            ...
            QCStatements = exports('Q', __decorate([
            ...
            var CertificateApplicationPolicies = /** @class */ (function (_super) {
                __extends(CertificateApplicationPolicies, _super);
                function CertificateApplicationPolicies() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
            ...
            var CertExtensions = /** @class */ (function (_super) {
            ...
            var AttestationIdentityKeyInfo = /** @class */ (function (_super) {
                __extends(AttestationIdentityKeyInfo, _super);
                function AttestationIdentityKeyInfo() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
            ...
            var EndorsementKeyInfo = /** @class */ (function (_super) {
                __extends(EndorsementKeyInfo, _super);
                function EndorsementKeyInfo() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
            ...
            var EnrollmentNameValuePairs = /** @class */ (function (_super) {
                __extends(EnrollmentNameValuePairs, _super);
                function EnrollmentNameValuePairs() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
            ...
            var LeiRoles = exports('L', /** @class */ (function () {
            ...
            var Structure = /** @class */ (function () {
                ...
                Structure.createStream = function (bytes) {
                    var view = BufferSourceConverter.toUint8Array(bytes);
            ...
            var X509Certificate = /** @class */ (function (_super) {
                ...
                function X509Certificate(raw) {
                    var _this = _super.call(this, X509Certificate.rawClarify(raw), Certificate) || this;
                    _this.thumbprints = {};
                    ...
                    _this.validity = diff(_this.notBefore, _this.notAfter);
                    return _this;
                }
                X509Certificate.base64Clear = function (base64) {
                    return base64
                        .replace(/.*base64,/, '')
                        .replace(/-----.+-----/g, '')
                        .replace(/[\s\r\n]/g, '');
                };
                X509Certificate.rawClarify = function (raw) {
                    var value = X509Certificate.base64Clear(raw);
                ...
                X509Certificate.prototype.export = function (type) {
                    if (type === 'base64') {
                ...
                X509Certificate.prototype.base64ToPem = function (base64) {
                    return "-----BEGIN CERTIFICATE-----\n" + base64.replace(/(.{64})/g, '$1\n') + "\n-----END CERTIFICATE-----";
                };
                X509Certificate.prototype.stringToHex = function (value) {
                    return value
                        .replace(/(.{32})/g, '$1\n')
                        .replace(/(.{4})/g, '$1 ')
                        .trim();
