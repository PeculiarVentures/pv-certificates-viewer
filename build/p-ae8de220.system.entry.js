...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Oe=function(e){__extends(t,e);function t(t){var i=e.call(this,t,o)||this;var r=i.getAsnExtnValue();switch(i.asn.type){case K:i.value=l.parse(r,T);break;case N:i.value=l.parse(r,j);break;case L:i.value=l.parse(r,z);break;case D:i.value=l.parse(r,A);break;case C:i.value=l.parse(r,I);break;case S:i.value=l.parse(r,_);break;case w:i.value=l.parse(r,k);break;case x:i.value=l.parse(r,y);break;case v:i.value=l.parse(r,m);break;case h:i.value=l.parse(r,g);break;case b:i.value=l.parse(r,p);break;case c:{var n=l.parse(r,u);i.value=n.map((function(e){return new d(f.serialize(e))}));break}default:i.value=s.Convert.ToHex(r)}return i}t.prototype.getAsnExtnValue=function(){return this.asn.values[0]};return t}(a);
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Fe=function(e){var i=e.signature;if(!i){return null}return[t(Be,{value:Ke.getString("signature")}),t(qe,{name:Ke.getString("algorithm"),value:Ve(i.algorithm)}),t(qe,{name:Ke.getString("value"),value:s.Convert.ToHex(i.value),monospace:true,collapse:true})]};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var at=function(e){var i=e.attributes;if(!i||!i.length){return null}return[t(Be,{value:"Attributes"}),i.map((function(e){try{if(e.value instanceof Y){return t(Ye,{attribute:e})}if(e.value instanceof _){return t(Je,{attribute:e})}if(e.value instanceof k){return t(We,{attribute:e})}if(e.value instanceof y){return t(Ze,{attribute:e})}if(e.value instanceof I){return t($e,{attribute:e})}if(e.value instanceof m){return t(tt,{attribute:e})}if(e.value instanceof p){return t(rt,{attribute:e})}if(e.value instanceof g){return t(nt,{attribute:e})}if(typeof e.value==="string"){return t(it,{attribute:e})}return t(Ue,{attribute:e})}catch(i){console.error("Error render attribute:",e.asn.type);return null}}))]};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var ot=function(e){var i=e.thumbprints;if(!i){return null}var r=Object.keys(i);if(!r.length){return null}return[t(Be,{value:Ke.getString("fingerprints")}),r.map((function(e){return t(qe,{name:e,value:i[e],monospace:true})}))]};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var bt=function(e){var i=e.extension;return t(st,{extension:i},i.value.map((function(i){var r;return(r=i===null||i===void 0?void 0:i.distributionPoint)===null||r===void 0?void 0:r.fullName.map((function(i){return t(Xe,Object.assign({generalName:i},e))}))})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var pt=function(e){var i=e.extension;return t(st,{extension:i},i.value.map((function(i,r){return[t(qe,{name:"Description #"+(r+1),value:""}),t(qe,{name:"Method",value:Ve(i.accessMethod)}),t(Xe,Object.assign({generalName:i.accessLocation},e))]})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Ct=function(e){var i=e.extension;return t(st,{extension:i},t(qe,{name:"Type",value:i.value.toJSON().join(", ")}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var It=function(e){var i=e.extension;return t(st,{extension:i},t(qe,{name:"Role",value:i.value.text}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Kt=function(e){var i=e.extension;return t(st,{extension:i},t(qe,{name:"Value",value:i.value,monospace:true}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Tt=function(e){var i=e.extension;return t(st,{extension:i},t(qe,{name:"Not Before",value:Te(i.value.notBefore)}),t(qe,{name:"Not After",value:Te(i.value.notAfter)}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Vt=function(e){var i=e.serialNumber,r=e.version,n=e.validity,a=e.notBefore,o=e.notAfter,s=e.type;return[t(Be,{value:Ke.getString("basicInformation")}),t(qe,{name:Ke.getString("type"),value:s}),t(qe,{name:Ke.getString("serialNumber"),value:i,monospace:true}),t(qe,{name:Ke.getString("version"),value:r}),t(qe,{name:Ke.getString("validity"),value:n}),t(qe,{name:Ke.getString("issued"),value:a?Te(a):undefined}),t(qe,{name:Ke.getString("expired"),value:o?Te(o):undefined})]};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */function Gt(e){if(e instanceof Re){Ie.certificateRequest.asPEM(e.exportAsPemFormatted(),e.commonName)}else{Ie.certificate.asPEM(e.exportAsPemFormatted(),e.commonName)}}function Bt(e){if(e instanceof Re){Ie.certificateRequest.asDER(e.exportAsHexFormatted(),e.commonName)}else{Ie.certificate.asDER(e.exportAsHexFormatted(),e.commonName)}}var qt=function(e){var i=e.certificate;return[t(Be,{value:Ke.getString("miscellaneous")}),t("tr",null,t("td",{class:"vertical_align_middle"},t("peculiar-typography",{color:"grey_5"},Ke.getString("download"),":")),t("td",null,t("peculiar-button-split",{onClick:Gt.bind(undefined,i),actions:[{text:Ke.getString("download.der"),onClick:Bt.bind(undefined,i)}]},Ke.getString("download.pem"))))]};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Yt=function(e){var i=e.issuer;if(!i){return null}return[t(Be,{value:Ke.getString("issuer")}),i.map((function(e){return t(Xe,{generalName:e,getDNSNameLink:function(){return""},getIPAddressLink:function(){return""}})}))]};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */function ri(e){var t;if((t=e.params)===null||t===void 0?void 0:t["modulus"]){var i=e.params["modulus"].byteLength;if(i%2){i-=1}return i*8}return null}function ni(e){var t;if((t=e.params)===null||t===void 0?void 0:t["publicExponent"]){return e.params["publicExponent"].byteLength===3?65537:3}return null}var ai=function(e){var i;var r=e.publicKey;if(!r){return null}return[t(Be,{value:Ke.getString("publicKeyInfo")}),t(qe,{name:Ke.getString("algorithm"),value:Ve(r.algorithm)}),t(qe,{name:Ke.getString("namedCurve"),value:Ve((i=r.params)===null||i===void 0?void 0:i["namedCurve"])}),t(qe,{name:Ke.getString("exponent"),value:ni(r)}),t(qe,{name:Ke.getString("modulus"),value:ri(r)}),t(qe,{name:Ke.getString("value"),value:s.Convert.ToHex(r.value),monospace:true,collapse:true})]};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
