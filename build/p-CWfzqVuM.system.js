...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var k=n("T",(function(n){var t=n.thumbprints;if(!t){return null}var u=Object.keys(t);if(!u.length){return null}return[e(m,{value:r.getString("fingerprints")}),u.map((function(n){return e(p,{name:n,value:t[n],monospace:true})}))]}));
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var w=n("M",(function(n){var t=n.certificate;return[e(m,{value:r.getString("miscellaneous")}),e("tr",null,e("td",null,e(o,{startIcon:e(c,null),onClick:function(){return t.downloadAsPEM()}},r.getString("download.pem")))),e("tr",null,e("td",null,e(o,{startIcon:e(c,null),onClick:function(){return t.downloadAsDER()}},r.getString("download.der"))))]}));
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var _=function(n){return"https://search.gleif.org/#/record/".concat(n)};var x=function(n){return"https://search.censys.io/search?resource=hosts&q=dns.names%3A".concat(n)};var K=function(n){return"https://search.censys.io/search?resource=hosts&q=ip%3A".concat(n)};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */function O(n){if(!n._type||n.value==null)return undefined;var e=String(n.value);switch(n._type){case"dNSName":return x(e);case"iPAddress":return K(e);case"lei":return _(e);default:return undefined}}function C(n,r){var t,a,l,o,c;var s=u((t=n.title)!==null&&t!==void 0?t:"",true);var v=O(n);var f=n.value!=null?u(String(n.value)):"";if(n._type==="authorityKeyId"&&n.value!=null){var d=(a=r.getAuthKeyIdParentLink)===null||a===void 0?void 0:a.call(r,f);var m=(l=r.getAuthKeyIdSiblingsLink)===null||l===void 0?void 0:l.call(r,f);return e(p,{name:s,value:f,monospace:true,extraValue:[d&&e("span",null," [",e(i,{href:d},"parents"),"]"),m&&e("span",null," [",e(i,{href:m},"siblings"),"]")]})}if(n._type==="subjectKeyId"&&n.value!=null){var h=(o=r.getSubjectKeyIdChildrenLink)===null||o===void 0?void 0:o.call(r,f);var m=(c=r.getSubjectKeyIdSiblingsLink)===null||c===void 0?void 0:c.call(r,f);return e(p,{name:s,value:f,monospace:true,extraValue:[h&&e("span",null," [",e(i,{href:h},"children"),"]"),m&&e("span",null," [",e(i,{href:m},"siblings"),"]")]})}return e(p,{name:s,
// eslint-disable-next-line no-nested-ternary
value:typeof n.value==="boolean"?n.value?"YES":"NO":f,href:v})}function N(n,r){var t,a,i;if(n.title&&!((t=n.value)===null||t===void 0?void 0:t.toString())){return[e(p,{name:u(n.title),value:""}),e(d,null,(a=n.children)===null||a===void 0?void 0:a.map((function(n){return N(n,r)})))]}if((i=n.children)===null||i===void 0?void 0:i.length){return e(d,null,n.title&&e("tr",null,e("td",{colSpan:2},e(l,{variant:"b2",color:"gray-9"},u(n.title)))),n.children.map((function(n){return N(n,r)})))}return C(n,r)}
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
