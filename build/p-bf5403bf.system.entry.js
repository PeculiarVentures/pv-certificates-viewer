...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Oe=function(e){__extends(t,e);function t(t){var i=e.call(this,t,o)||this;var r=i.getAsnExtnValue();switch(i.asn.type){case E:i.value=l.parse(r,P);break;case z:i.value=l.parse(r,j);break;case D:i.value=l.parse(r,N);break;case A:i.value=l.parse(r,L);break;case I:i.value=l.parse(r,C);break;case S:i.value=l.parse(r,_);break;case k:i.value=l.parse(r,w);break;case y:i.value=l.parse(r,x);break;case v:i.value=l.parse(r,m);break;case h:i.value=l.parse(r,g);break;case p:i.value=l.parse(r,b);break;case c:{var n=l.parse(r,u);i.value=n.map((function(e){return new d(f.serialize(e))}));break}default:i.value=s.Convert.ToHex(r)}return i}t.prototype.getAsnExtnValue=function(){return this.asn.values[0]};return t}(a);
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var At=function(e){var i=e.extension,r=e.getLEILink;return t(st,{extension:i},t(qe,{name:"Identifier",value:i.value.text,href:r(i.value.text)}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Lt=function(e){var i=e.extension;return t(st,{extension:i},t(qe,{name:"Version",value:i.value.version}),t(Xe,Object.assign({generalName:i.value.location},e)),t(qe,{name:"Requires Auth",value:i.value.requiresAuth?"YES":"NO"}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Dt=function(e){var i=e.extension;return t(st,{extension:i},t(qe,{name:"Version",value:i.value.version}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
