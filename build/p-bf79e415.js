 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ae=a=>{const{thumbprints:t}=a;if(!t){return null}const c=Object.keys(t);if(!c.length){return null}return[e(ve,{value:n.getString("fingerprints")}),c.map((a=>e(pe,{name:a,value:t[a],monospace:true})))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ie=(a,t)=>{const{extension:c}=a;return[e(pe,{name:"Name",value:ie(c.asn.extnID)}),e(pe,{name:"Critical",value:c.asn.critical?n.getString("yes"):n.getString("no")}),t,e("tr",null,e("td",{colSpan:2,class:"divider"},e("span",null)))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const De=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Usage",value:n.value.toJSON().join(", ")}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const je=a=>{const{extension:t}=a;return e(Ie,{extension:t},e(pe,{name:"Certificate Authority",value:t.value.cA?n.getString("yes"):n.getString("no")}),e(pe,{name:"Path Length Constraint",value:t.value.pathLenConstraint}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Oe=a=>{const{extension:n}=a;return e(Ie,{extension:n},Boolean(n.value.length)&&[e(pe,{name:"Purposes",value:""}),n.value.map((a=>e(me,null,e(pe,{name:"Purpose",value:ie(a)}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ge=a=>{const{extension:n,getSubjectKeyIdChildrenLink:t,getSubjectKeyIdSiblingsLink:c}=a;const o=ne.ToHex(n.value.buffer);const s=t(o);const r=c(o);return e(Ie,{extension:n},e(pe,{name:"Key ID",value:o,monospace:true,extraValue:[s&&e("span",null," [",e(ce,{href:s},"children"),"]"),r&&e("span",null," [",e(ce,{href:r},"siblings"),"]")]}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Te=a=>{const{extension:n,getAuthKeyIdParentLink:t,getAuthKeyIdSiblingsLink:c}=a;const o=ne.ToHex(n.value.keyIdentifier.buffer);const s=t(o);const r=c(o);return e(Ie,{extension:n},e(pe,{name:"Key ID",value:o,monospace:true,extraValue:[s&&e("span",null," [",e(ce,{href:s},"parents"),"]"),r&&e("span",null," [",e(ce,{href:r},"siblings"),"]")]}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Re=a=>{const{extension:n}=a;return e(Ie,{extension:n},Boolean(n.value.length)&&[e(pe,{name:"Descriptions",value:""}),n.value.map((n=>e(me,null,e(pe,{name:"Method",value:ie(n.accessMethod)}),e(Le,Object.assign({generalName:n.accessLocation},a)))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ee=a=>{const{extension:n}=a;return e(Ie,{extension:n},Boolean(n.value.items.length)&&[e(pe,{name:"Signed Certificate Timestamps",value:""}),n.value.toJSON().map((a=>e(me,null,e(pe,{name:"Version",value:a.version+1}),e(pe,{name:"Log Operator",value:$e[a.logId]||a.logId}),e(pe,{name:"Log Key ID",value:a.logId,monospace:true}),e(pe,{name:"Timestamp",value:t(a.timestamp)}),e(pe,{name:"Signature Algorithm",value:`${a.hashAlgorithm} ${a.signatureAlgorithm}`.toUpperCase()}),e(pe,{name:"Signature",value:a.signature,monospace:true}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ue=a=>{var n,t;const{extension:c}=a;return e(Ie,{extension:c},(n=c.value.excludedSubtrees)===null||n===void 0?void 0:n.map((n=>e(Le,Object.assign({generalName:n.base},a)))),(t=c.value.permittedSubtrees)===null||t===void 0?void 0:t.map((n=>e(Le,Object.assign({generalName:n.base},a)))))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ke=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Template ID",value:n.value.templateID}),e(pe,{name:"Template Major Version",value:n.value.templateMajorVersion}),e(pe,{name:"Template Minor Version",value:n.value.templateMinorVersion}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const He=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Name",value:n.value.toString()}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const ra=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Comment",value:n.value.value}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const ia=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Type",value:n.value.toJSON().join(", ")}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const fa=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Role",value:n.value.text}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const ua=a=>{const{extension:n,getLEILink:t}=a;return e(Ie,{extension:n},e(pe,{name:"Identifier",value:n.value.text,href:t(n.value.text)}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const la=a=>{const{extension:t}=a;return e(Ie,{extension:t},e(pe,{name:"Version",value:t.value.version}),e(Le,Object.assign({generalName:t.value.location},a)),e(pe,{name:"Requires Auth",value:t.value.requiresAuth?n.getString("yes"):n.getString("no")}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const da=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Version",value:n.value.version}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const ba=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Reason",value:n.value.toJSON()}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const va=a=>{const{extension:n}=a;return e(Ie,{extension:n},Boolean(n.value.length)&&[e(pe,{name:"Attributes",value:""}),n.value.map((a=>e(me,null,e(pe,{name:"Type",value:ie(a.type)}),e(pe,{name:"Value",value:ma(a)}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const pa=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Value",value:n.value,monospace:true}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const xa=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Not Before",value:t(n.value.notBefore)}),e(pe,{name:"Not After",value:t(n.value.notAfter)}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const ga=a=>{const{extension:n}=a;return e(Ie,{extension:n},e(pe,{name:"Version",value:n.value.entrustVers}),e(pe,{name:"Info Flags",value:n.value.entrustInfoFlags.toJSON().join(", ")}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ca=a=>{const{extension:n}=a;return e(Ie,{extension:n},n.value.map(((a,n)=>[e(pe,{name:`Entry #${n+1}`,value:""}),e(pe,{name:"SPC",value:a.spc}),e(pe,{name:"Range",value:a.range?`start=${a.range.start} count==${a.range.count}`:null}),e(pe,{name:"One",value:a.one})])))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Na=a=>{const{extension:n}=a;return e(Ie,{extension:n},n.value.map(((a,n)=>[e(pe,{name:`Policy #${n+1}`,value:""}),e(pe,{name:"Issuer Domain",value:ie(a.issuerDomainPolicy)}),e(pe,{name:"Subject Domain",value:ie(a.subjectDomainPolicy)})])))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Aa=a=>{const{extension:t}=a;return e(Ie,{extension:t},e(pe,{name:n.getString("value"),value:t.value.value}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
