import { r as registerInstance, h } from './core-921931c1.js';
import { C as Certificate, E as EnumOIDs } from './index-bc177fd4.js';
...
const CertificateViewer = class {
    ...
    renderRowValue(title, value, valueMonospace) {
    ...
    render() {
        ...
        return (h("table", null, this.renderRowTitle('PEM'), h("tr", null, h("td", { colSpan: 2 }, h("div", { class: "pem_block stroke_grey_3_border b3 text_black monospace" }, this.cert.pem))), this.renderRowTitle('Basic Information'), h("tr", null, h("td", { colSpan: 2 }, h("pv-certificate-summary", { certificate: this.cert }))), this.renderRowTitle('Public Key Info'), this.renderRowValue('Algorithm', this.cert.publicKey.algorithm.name), this.renderRowValue('Modulus Bits', this.cert.publicKey.algorithm.modulusBits), this.renderRowValue('Public Exponent', this.cert.publicKey.algorithm.publicExponent), this.renderRowValue('Named Curve', this.cert.publicKey.algorithm.namedCurve), this.renderRowValue('Value', this.cert.publicKey.value, true), this.renderRowTitle('Signature'), this.renderRowValue('Algorithm', this.cert.signature.algorithm.name), this.renderRowValue('Hash', this.cert.signature.algorithm.hash), this.renderRowValue('Value', this.cert.signature.value, true), this.renderRowTitle('Extensions'), this.cert.extensions.map((extension) => ([
