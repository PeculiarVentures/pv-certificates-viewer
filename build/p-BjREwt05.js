 ...
 */
import{h as e}from"./p-B0tLzdJT.js";import{$ as n,Z as a,_ as t,b as c,bn as o,bo as s,q as r,bp as i,bq as f,br as u,bs as l,bt as b,bu as d,bv as m,bw as v,bx as p,by as x,bz as g,bA as y,bB as h,bC as C,bD as N,au as S,aE as A,ay as I,ao as D,aF as j,aB as O,aG as T,a8 as G,aq as k,aC as L,at as P,am as B,al as V,ai as R,an as E,ak as $,aj as U,ag as K,ah as q,af as H,ae as M,az as X,ap as w,ad as Y,ac as z,ab as F,aa as Z,a9 as Q,as as W,ar as J,a7 as _,aA as ee,a5 as ne,a4 as ae}from"./p-CmOVFH_Z.js";import{L as te}from"./p-BrjKJZAs.js";import{C as ce}from"./p-DXA1451q.js";import{T as oe,B as se}from"./p-BNRN5kAu.js";import{D as re}from"./p-CVqAvraM.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ne=n=>{const{name:t,issuerDnLink:c}=n;const o=a.getString("issuerName");return[e(ve,{value:c?e(te,{href:c},o):o}),t.map((n=>e(pe,{name:n.name||n.type,value:n.value})))]};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Oe=n=>{const{extension:a}=n;return e(Ie,{extension:a},Boolean(a.value.length)&&[e(pe,{name:"Purposes",value:""}),a.value.map((n=>e(me,null,e(pe,{name:"Purpose",value:ie(n)}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Te=n=>{const{extension:a,getSubjectKeyIdChildrenLink:t,getSubjectKeyIdSiblingsLink:o}=n;const s=c.Convert.ToHex(a.value.buffer);const r=t(s);const i=o(s);return e(Ie,{extension:a},e(pe,{name:"Key ID",value:s,monospace:true,extraValue:[r&&e("span",null," [",e(te,{href:r},"children"),"]"),i&&e("span",null," [",e(te,{href:i},"siblings"),"]")]}))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ve=n=>{const{extension:a}=n;return e(Ie,{extension:a},a.value.map((a=>e(Le,Object.assign({generalName:a},n)))))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const $e=n=>{const{extension:a}=n;return e(Ie,{extension:a},Boolean(a.value.items.length)&&[e(pe,{name:"Signed Certificate Timestamps",value:""}),a.value.toJSON().map((n=>e(me,null,e(pe,{name:"Version",value:n.version+1}),e(pe,{name:"Log Operator",value:Ee[n.logId]||n.logId}),e(pe,{name:"Log Key ID",value:n.logId,monospace:true}),e(pe,{name:"Timestamp",value:t(n.timestamp)}),e(pe,{name:"Signature Algorithm",value:`${n.hashAlgorithm} ${n.signatureAlgorithm}`.toUpperCase()}),e(pe,{name:"Signature",value:n.signature,monospace:true}),e(pe,{name:"Extensions",value:n.extensions||undefined,monospace:true}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const He=n=>{const{extension:a}=n;const t=a.value.getVersion();return e(Ie,{extension:a},e(pe,{name:"Certificate Index",value:t.certificateIndex}),e(pe,{name:"Key Index",value:t.keyIndex}))};var Me,Xe,we,Ye;let ze=class e{constructor(e){if(typeof e==="string"){this.alphabetic=e}else if(typeof e==="number"){this.numeric=e}}};l([b({type:d.PrintableString})],ze.prototype,"alphabetic",void 0);l([b({type:d.PrintableString})],ze.prototype,"numeric",void 0);ze=l([m({type:v.Choice})],ze);class Fe{constructor(e={}){this.currency=new ze;this.amount=0;this.exponent=0;Object.assign(this,e)}}l([b({type:ze})],Fe.prototype,"currency",void 0);l([b({type:d.Integer})],Fe.prototype,"amount",void 0);l([b({type:d.Integer})],Fe.prototype,"exponent",void 0);let Ze=class e extends Fe{};Ze=l([m({type:v.Sequence})],Ze);let Qe=class e{constructor(e=0){this.value=e}};l([b({type:d.Integer})],Qe.prototype,"value",void 0);Qe=l([m({type:v.Choice})],Qe);let We=class e{constructor(e={}){this.url="";this.language="";Object.assign(this,e)}};l([b({type:d.IA5String})],We.prototype,"url",void 0);l([b({type:d.PrintableString})],We.prototype,"language",void 0);We=l([m({type:v.Sequence})],We);let Je=Me=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Me.prototype)}};Je=Me=l([m({type:v.Sequence,itemType:We})],Je);let _e=Xe=class e extends Je{constructor(e){super(e);Object.setPrototypeOf(this,Xe.prototype)}};_e=Xe=l([m({type:v.Sequence,itemType:We})],_e);let en=we=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,we.prototype)}};en=we=l([m({type:v.Sequence,itemType:d.ObjectIdentifier})],en);let nn=Ye=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Ye.prototype)}};nn=Ye=l([m({type:v.Sequence,itemType:d.PrintableString})],nn);const an="0.4.0.1862.1";const tn=`${an}.3`;const cn=`${an}.5`;const on=`${an}.6`
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */;const sn=n=>{const{extension:a}=n;function t(n,a){if(!a||!a.byteLength){return null}if(n===x){const n=r.parse(a,g);return e(pe,{name:"Semantics Identifier",value:ie(n.semanticsIdentifier)})}if(n===on){const n=r.parse(a,en);return e(pe,{name:"QC Types",value:n.map((e=>ie(e))).join(", ")})}if(n===tn){const n=r.parse(a,Qe);return e(pe,{name:"Retention Period",value:`${n.value} years`})}if(n===cn){const n=r.parse(a,Je);return[e(pe,{name:"PDS Locations",value:""}),n.map((n=>e(me,null,e(pe,{name:"URL",value:n.url}),e(pe,{name:"Language",value:n.language}))))]}return e(pe,{name:"Info",value:c.Convert.ToHex(a),monospace:true})}return e(Ie,{extension:a},Boolean(a.value.length)&&[e(pe,{name:"Statements",value:""}),a.value.map((n=>e(me,null,e(pe,{name:"Statement ID",value:ie(n.statementId)}),t(n.statementId,n.statementInfo))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Nn=n=>{const{extension:a}=n;return e(Ie,{extension:a},a.value.length>0&&[e(pe,{name:"Entries",value:""}),a.value.map((n=>e(me,null,e(pe,{name:"SPC",value:n.spc}),e(pe,{name:"Range",value:n.range?`start=${n.range.start} count==${n.range.count}`:null}),e(pe,{name:"One",value:n.one}))))])};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const On=n=>{const{extension:a}=n;return e(Ie,{extension:a},Object.keys(a.value).map((n=>e(pe,{name:fe(n),value:a.value[n]}))))};
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Gn=n=>{const{certificate:t}=n;return[e(ve,{value:a.getString("miscellaneous")}),e("tr",null,e("td",null,e(se,{startIcon:e(re,null),onClick:()=>t.downloadAsPEM()},a.getString("download.pem")))),e("tr",null,e("td",null,e(se,{startIcon:e(re,null),onClick:()=>t.downloadAsDER()},a.getString("download.der"))))]};export{xe as B,Tn as E,Le as G,Ne as I,Gn as M,he as P,pe as R,Ce as S,Ae as T,Se as a,le as b,ue as c,ie as d,fe as e,me as f,be as g,ve as h};
//# sourceMappingURL=p-BjREwt05.js.map