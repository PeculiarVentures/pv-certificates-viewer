 ...
 */
import{h as e}from"./p-1ad9064c.js";import{_ as a,Y as n,Z as t,C as c,$ as s,a3 as o,b as r,a4 as i,a5 as f,a6 as u,a7 as l,a8 as d,a9 as b,aa as m,ab as v,ac as x,ad as p,ae as g,af as y,ag as h,ah as C,ai as S,aj as N,ak as A,al as I,am as D,an as j,ao as O,ap as G,aq as T,ar as k,as as L,at as P,au as R,av as V,aw as B,ax as $,ay as E,az as U,aA as K,aB as H,aC as M,aD as Y,aE as q,aF as w,a0 as X,aG as Q,aH as z,aI as F,aJ as W,aK as Z,aL as J,aM as _,aN as ee,aO as ae,aP as ne,aQ as te,aR as ce}from"./p-bfbdf73e.js";import{L as se}from"./p-5bfe3fcc.js";import{T as oe,B as re}from"./p-56e68c42.js";import{D as ie}from"./p-f6538bbd.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Ye=a=>{const{extension:n}=a;const t=n.value.getVersion();return e(De,{extension:n},e(pe,{name:"Certificate Index",value:t.certificateIndex}),e(pe,{name:"Key Index",value:t.keyIndex}))};var qe,we,Xe,Qe;let ze=class e{constructor(e){if(typeof e==="string"){this.alphabetic=e}else if(typeof e==="number"){this.numeric=e}}};d([b({type:m.PrintableString})],ze.prototype,"alphabetic",void 0);d([b({type:m.PrintableString})],ze.prototype,"numeric",void 0);ze=d([v({type:x.Choice})],ze);class Fe{constructor(e={}){this.currency=new ze;this.amount=0;this.exponent=0;Object.assign(this,e)}}d([b({type:ze})],Fe.prototype,"currency",void 0);d([b({type:m.Integer})],Fe.prototype,"amount",void 0);d([b({type:m.Integer})],Fe.prototype,"exponent",void 0);let We=class e extends Fe{};We=d([v({type:x.Sequence})],We);let Ze=class e{constructor(e=0){this.value=e}};d([b({type:m.Integer})],Ze.prototype,"value",void 0);Ze=d([v({type:x.Choice})],Ze);let Je=class e{constructor(e={}){this.url="";this.language="";Object.assign(this,e)}};d([b({type:m.IA5String})],Je.prototype,"url",void 0);d([b({type:m.PrintableString})],Je.prototype,"language",void 0);Je=d([v({type:x.Sequence})],Je);let _e=qe=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,qe.prototype)}};_e=qe=d([v({type:x.Sequence,itemType:Je})],_e);let ea=we=class e extends _e{constructor(e){super(e);Object.setPrototypeOf(this,we.prototype)}};ea=we=d([v({type:x.Sequence,itemType:Je})],ea);let aa=Xe=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Xe.prototype)}};aa=Xe=d([v({type:x.Sequence,itemType:m.ObjectIdentifier})],aa);let na=Qe=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Qe.prototype)}};na=Qe=d([v({type:x.Sequence,itemType:m.PrintableString})],na);const ta="0.4.0.1862.1";const ca=`${ta}.3`;const sa=`${ta}.5`;const oa=`${ta}.6`
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
...
//# sourceMappingURL=p-54e8b67c.js.map