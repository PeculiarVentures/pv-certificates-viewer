 ...
 */
import{h as e}from"./p-Dpo1Lsuj.js";import{a6 as n,a4 as a,a5 as t,b as c,bn as o,bo as s,q as r,bp as i,bq as f,br as u,bs as l,bt as b,bu as d,bv as m,bw as v,bx as p,by as x,bz as g,bA as y,bB as h,bC as C,bD as S,aA as N,aK as A,aE as D,au as I,aL as j,aH as O,aM as T,ae as G,aw as L,aI as k,az as P,as as V,ar as B,ao as R,at as E,aq as $,ap as U,am as K,an as q,al as H,ak as Y,aF as w,av as M,aj as X,ai as z,ah as W,ag as F,af as Q,ay as J,ax as Z,ad as _,aG as ee,ab as ne,aa as ae}from"./p-BAWY85mT.js";import{L as te}from"./p-BoVBJ09p.js";import{C as ce}from"./p-CuRXqhnb.js";import{T as oe,B as se}from"./p-GTlYmF1j.js";import{D as re}from"./p-DzEcDVLW.js";
/**
 * @license
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const He=n=>{const{extension:a}=n;const t=a.value.getVersion();return e(De,{extension:a},e(pe,{name:"Certificate Index",value:t.certificateIndex}),e(pe,{name:"Key Index",value:t.keyIndex}))};var Ye,we,Me,Xe;let ze=class e{constructor(e){if(typeof e==="string"){this.alphabetic=e}else if(typeof e==="number"){this.numeric=e}}};l([b({type:d.PrintableString})],ze.prototype,"alphabetic",void 0);l([b({type:d.PrintableString})],ze.prototype,"numeric",void 0);ze=l([m({type:v.Choice})],ze);class We{constructor(e={}){this.currency=new ze;this.amount=0;this.exponent=0;Object.assign(this,e)}}l([b({type:ze})],We.prototype,"currency",void 0);l([b({type:d.Integer})],We.prototype,"amount",void 0);l([b({type:d.Integer})],We.prototype,"exponent",void 0);let Fe=class e extends We{};Fe=l([m({type:v.Sequence})],Fe);let Qe=class e{constructor(e=0){this.value=e}};l([b({type:d.Integer})],Qe.prototype,"value",void 0);Qe=l([m({type:v.Choice})],Qe);let Je=class e{constructor(e={}){this.url="";this.language="";Object.assign(this,e)}};l([b({type:d.IA5String})],Je.prototype,"url",void 0);l([b({type:d.PrintableString})],Je.prototype,"language",void 0);Je=l([m({type:v.Sequence})],Je);let Ze=Ye=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Ye.prototype)}};Ze=Ye=l([m({type:v.Sequence,itemType:Je})],Ze);let _e=we=class e extends Ze{constructor(e){super(e);Object.setPrototypeOf(this,we.prototype)}};_e=we=l([m({type:v.Sequence,itemType:Je})],_e);let en=Me=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Me.prototype)}};en=Me=l([m({type:v.Sequence,itemType:d.ObjectIdentifier})],en);let nn=Xe=class e extends p{constructor(e){super(e);Object.setPrototypeOf(this,Xe.prototype)}};nn=Xe=l([m({type:v.Sequence,itemType:d.PrintableString})],nn);const an="0.4.0.1862.1";const tn=`${an}.3`;const cn=`${an}.5`;const on=`${an}.6`
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const Gn=n=>{const{certificate:t}=n;return[e(ve,{value:a.getString("miscellaneous")}),e("tr",null,e("td",null,e(se,{startIcon:e(re,null),onClick:()=>t.downloadAsPEM()},a.getString("download.pem")))),e("tr",null,e("td",null,e(se,{startIcon:e(re,null),onClick:()=>t.downloadAsDER()},a.getString("download.der"))))]};export{xe as B,Tn as E,ke as G,Se as I,Gn as M,he as P,pe as R,Ce as S,Ae as T,Ne as a,le as b,ue as c,ie as d,fe as e,me as f,be as g,ve as h};
//# sourceMappingURL=p-BWqJaoUv.js.map