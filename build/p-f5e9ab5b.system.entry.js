...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Qe={otherName:"Other Name",rfc822Name:"RFC 822 Name",dNSName:"DNS Name",x400Address:"X400 Address",directoryName:"Directory Name",ediPartyName:"Edi Party Name ",uniformResourceIdentifier:"URI",iPAddress:"IP Address",registeredID:"Registered ID"};var Je=function(e){var i=e.generalName,r=e.getDNSNameLink,n=e.getIPAddressLink;if(!i){return null}return Object.keys(i).map((function(e){var a=i[e];if(a instanceof Y){return[t(qe,{name:Qe[e]||e,value:""}),a.map((function(e){return e.map((function(e){return t(qe,{name:M[e.type]||e.type,value:e.value.toString()})}))}))]}if(a instanceof Q){var o=l.parse(a.value,J);return t(qe,{name:M[a.typeId],value:o.toString()})}if(s.BufferSourceConverter.isBufferSource(a)){return t(qe,{name:Qe[e]||e,value:s.Convert.ToString(a)})}if(a instanceof W){return t(qe,{name:Qe[e]||e,value:s.Convert.ToString(a.partyName)})}if(e==="dNSName"){return t(qe,{name:Qe[e]||e,value:a,href:r(a)})}if(e==="iPAddress"){return t(qe,{name:Qe[e]||e,value:a,href:n(a)})}return t(qe,{name:Qe[e]||e,value:a})}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var We=function(e){var i=e.attribute;return t(Ue,{attribute:i},t(qe,{name:"Code Authority",value:""}),t(Je,{generalName:i.value.codeAuthority,getDNSNameLink:function(){return""},getIPAddressLink:function(){return""}}),t(qe,{name:"Code Id",value:""}),t(Je,{generalName:i.value.codeId,getDNSNameLink:function(){return""},getIPAddressLink:function(){return""}}),t(qe,{name:"Short Name",value:i.value.shortName}),t(qe,{name:"Short Description",value:i.value.shortDescription}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Xe=function(e){var i=e.attribute;return t(Ue,{attribute:i},t(qe,{name:"Assessment Authority",value:""}),t(Je,{generalName:i.value.assessmentAuthority,getDNSNameLink:function(){return""},getIPAddressLink:function(){return""}}),t(qe,{name:"Assessment Location",value:""}),t(Je,{generalName:i.value.assessmentLocation,getDNSNameLink:function(){return""},getIPAddressLink:function(){return""}}),t(qe,{name:"Assessment Ref",value:""}),t(Je,{generalName:i.value.assessmentRef,getDNSNameLink:function(){return""},getIPAddressLink:function(){return""}}),t(qe,{name:"Data Storage Territory",value:i.value.dataStorageTerritory}),t(qe,{name:"Description",value:i.value.description}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var pt=function(e){var i=e.extension;return t(st,{extension:i},i.value.map((function(i){var r;return(r=i===null||i===void 0?void 0:i.distributionPoint)===null||r===void 0?void 0:r.fullName.map((function(i){return t(Je,Object.assign({generalName:i},e))}))})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var bt=function(e){var i=e.extension;return t(st,{extension:i},i.value.map((function(i,r){return[t(qe,{name:"Description #"+(r+1),value:""}),t(qe,{name:"Method",value:Ve(i.accessMethod)}),t(Je,Object.assign({generalName:i.accessLocation},e))]})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var ht=function(e){var i=e.extension;return t(st,{extension:i},i.value.map((function(i){return t(Je,Object.assign({generalName:i},e))})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var gt=function(e){var i=e.extension;return t(st,{extension:i},i.value.map((function(e,i){var r;return[t(qe,{name:"Policy #"+(i+1),value:""}),t(qe,{name:"ID",value:Ve(e.policyIdentifier)}),(r=e.policyQualifiers)===null||r===void 0?void 0:r.map((function(e,r){var n=[t(qe,{name:"Qualifier #"+(i+1)+"."+(r+1),value:""}),t(qe,{name:"ID",value:Ve(e.policyQualifierId)})];if(e.policyQualifierId==="1.3.6.1.5.5.7.2.1"){var a=l.parse(e.qualifier,J);n.push(t(qe,{name:"Value",value:a.toString()}))}if(e.policyQualifierId==="1.3.6.1.5.5.7.2.2"){var a=l.parse(e.qualifier,X);if(a.explicitText){n.push(t(qe,{name:"Value",value:a.explicitText.toString()}))}}return n}))]})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var yt=function(e){var i,r;var n=e.extension;return t(st,{extension:n},(i=n.value.excludedSubtrees)===null||i===void 0?void 0:i.map((function(i){return t(Je,Object.assign({generalName:i.base},e))})),(r=n.value.permittedSubtrees)===null||r===void 0?void 0:r.map((function(i){return t(Je,Object.assign({generalName:i.base},e))})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Dt=function(e){var i=e.extension;return t(st,{extension:i},t(qe,{name:"Version",value:i.value.version}),t(Je,Object.assign({generalName:i.value.location},e)),t(qe,{name:"Requires Auth",value:i.value.requiresAuth?"YES":"NO"}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Vt=function(e){var i=e.serialNumber,r=e.version,n=e.validity,a=e.notBefore,o=e.notAfter;return[t(Be,{value:Ee.getString("basicInformation")}),t(qe,{name:Ee.getString("serialNumber"),value:i,monospace:true}),t(qe,{name:Ee.getString("version"),value:r}),t(qe,{name:Ee.getString("validity"),value:n}),t(qe,{name:Ee.getString("issued"),value:Pe(a)}),t(qe,{name:Ee.getString("expired"),value:Pe(o)})]};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Ft=function(e){var i=e.issuer;if(!i){return null}return[t(Be,{value:Ee.getString("issuer")}),i.map((function(e){return t(Je,{generalName:e,getDNSNameLink:function(){return""},getIPAddressLink:function(){return""}})}))]};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
