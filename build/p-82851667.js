import { C as CSS, p as plt, w as win, a as promiseResolve, d as doc, N as NAMESPACE } from './p-4114264f.js';
...
const patchEsm = () => {
    ...
    if ( !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_peculiar(/* webpackChunkName: "polyfills-css-shim" */ './p-dea95669.js').then(() => {
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if ( !win.customElements) {
            ...
            // @ts-ignore
            return __sc_import_peculiar(/* webpackChunkName: "polyfills-dom" */ './p-ddb1a4ef.js').then(() => opts);
        }
    }
