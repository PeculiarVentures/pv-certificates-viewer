 ...
 */System.register(["./p-CCyzZ5j5.system.js","./p-DpGojJ9T.system.js","./p-BPj_AI1m.system.js","./p-E_lnxyrp.system.js","./p-DfK0DWXj.system.js","./p-at6kSwVv.system.js"],(function(e){"use strict";var n,a,r,t,u,c,f,i,o,l,d,b,s,v,m,p,g,y,x,h,C,S,j,N,A,D,I,O,T,G,P,V,_,k,R,E,B,L,U,w,H,X,K,M,Y,q,W,z,Q,F,Z,J,$,ee,ne,ae,re,te,ue,ce,fe,ie;return{setters:[function(e){n=e.h},function(e){a=e.a6;r=e.a4;t=e.a5;u=e.b;c=e.bn;f=e.bo;i=e.q;o=e.bp;l=e.bq;d=e.br;b=e.bs;s=e.bt;v=e.bu;m=e.bv;p=e.bw;g=e.bx;y=e.by;x=e.bz;h=e.bA;C=e.bB;S=e.bC;j=e.bD;N=e.aA;A=e.aK;D=e.aE;I=e.au;O=e.aL;T=e.aH;G=e.aM;P=e.ae;V=e.aw;_=e.aI;k=e.az;R=e.as;E=e.ar;B=e.ao;L=e.at;U=e.aq;w=e.ap;H=e.am;X=e.an;K=e.al;M=e.ak;Y=e.aF;q=e.av;W=e.aj;z=e.ai;Q=e.ah;F=e.ag;Z=e.af;J=e.ay;$=e.ax;ee=e.ad;ne=e.aG;ae=e.ab;re=e.aa},function(e){te=e.L},function(e){ue=e.C},function(e){ce=e.T;fe=e.B},function(e){ie=e.D}],execute:function(){e({d:oe,e:le});
/**
             * @license
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var je=e("I",(function(e){var a=e.name,t=e.issuerDnLink;var u=r.getString("issuerName");return[n(pe,{value:t?n(te,{href:t},u):u}),a.map((function(e){return n(ge,{name:e.name||e.type,value:e.value})}))]}));
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Ne=e("a",(function(e){var a=e.signature;if(!a){return null}function t(e){return[n(ge,{name:r.getString("algorithm"),value:oe(e.algorithm)}),n(ge,{name:r.getString("value"),value:u.Convert.ToHex(e.value),monospace:true,collapse:true})]}return[n(pe,{value:r.getString("signature")}),t(a),a.params&&a.params.length&&a.params.map((function(e){return n(me,null,t(e))}))]}));
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Ae=e("T",(function(e){var a=e.thumbprints;if(!a){return null}var t=Object.keys(a);if(!t.length){return null}return[n(pe,{value:r.getString("fingerprints")}),t.map((function(e){return n(ge,{name:e,value:a[e],monospace:true})}))]}));
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var De=function(e,a){var t=e.extension;return[n(ge,{name:"Name",value:oe(t.asn.extnID)}),n(ge,{name:"Critical",value:t.asn.critical?r.getString("yes"):r.getString("no")}),a,n("tr",null,n("td",{colSpan:2,class:"divider"},n("span",null)))]};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Ie=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Usage",value:a.value.toJSON().join(", ")}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Oe=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Certificate Authority",value:a.value.cA?r.getString("yes"):r.getString("no")}),n(ge,{name:"Path Length Constraint",value:a.value.pathLenConstraint}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Te=function(e){var a=e.extension;return n(De,{extension:a},Boolean(a.value.length)&&[n(ge,{name:"Purposes",value:""}),a.value.map((function(e){return n(me,null,n(ge,{name:"Purpose",value:oe(e)}))}))])};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Ge=function(e){var a=e.extension,r=e.getSubjectKeyIdChildrenLink,t=e.getSubjectKeyIdSiblingsLink;var c=u.Convert.ToHex(a.value.buffer);var f=r(c);var i=t(c);return n(De,{extension:a},n(ge,{name:"Key ID",value:c,monospace:true,extraValue:[f&&n("span",null," [",n(te,{href:f},"children"),"]"),i&&n("span",null," [",n(te,{href:i},"siblings"),"]")]}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Pe=function(e){var a=e.extension,r=e.getAuthKeyIdParentLink,t=e.getAuthKeyIdSiblingsLink;var c=u.Convert.ToHex(a.value.keyIdentifier.buffer);var f=r(c);var i=t(c);return n(De,{extension:a},n(ge,{name:"Key ID",value:c,monospace:true,extraValue:[f&&n("span",null," [",n(te,{href:f},"parents"),"]"),i&&n("span",null," [",n(te,{href:i},"siblings"),"]")]}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var ke=function(e){var a=e.extension;return n(De,{extension:a},a.value.map((function(a){var r,t;return[(r=a.distributionPoint)===null||r===void 0?void 0:r.fullName.map((function(a){return n(_e,Object.assign({generalName:a},e))})),(t=a.cRLIssuer)===null||t===void 0?void 0:t.map((function(a){return n(_e,Object.assign({generalName:a},e))}))]})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Re=function(e){var a=e.extension;return n(De,{extension:a},Boolean(a.value.length)&&[n(ge,{name:"Descriptions",value:""}),a.value.map((function(a){return n(me,null,n(ge,{name:"Method",value:oe(a.accessMethod)}),n(_e,Object.assign({generalName:a.accessLocation},e)))}))])};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Ee=function(e){var a=e.extension;return n(De,{extension:a},a.value.map((function(a){return n(_e,Object.assign({generalName:a},e))})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var we=function(e){var a,r;var t=e.extension;return n(De,{extension:t},(a=t.value.excludedSubtrees)===null||a===void 0?void 0:a.map((function(a){return n(_e,Object.assign({generalName:a.base},e))})),(r=t.value.permittedSubtrees)===null||r===void 0?void 0:r.map((function(a){return n(_e,Object.assign({generalName:a.base},e))})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Xe=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Name",value:a.value.toString()}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Ke=function(e){var a=e.extension;var r=a.value.getVersion();return n(De,{extension:a},n(ge,{name:"Certificate Index",value:r.certificateIndex}),n(ge,{name:"Key Index",value:r.keyIndex}))};var Me,Ye,qe,We;var ze=function(){function e(e){if(typeof e==="string"){this.alphabetic=e}else if(typeof e==="number"){this.numeric=e}}return e}();b([s({type:v.PrintableString})],ze.prototype,"alphabetic",void 0);b([s({type:v.PrintableString})],ze.prototype,"numeric",void 0);ze=b([m({type:p.Choice})],ze);var Qe=function(){function e(e){if(e===void 0){e={}}this.currency=new ze;this.amount=0;this.exponent=0;Object.assign(this,e)}return e}();b([s({type:ze})],Qe.prototype,"currency",void 0);b([s({type:v.Integer})],Qe.prototype,"amount",void 0);b([s({type:v.Integer})],Qe.prototype,"exponent",void 0);var Fe=function(e){__extends(n,e);function n(){return e!==null&&e.apply(this,arguments)||this}return n}(Qe);Fe=b([m({type:p.Sequence})],Fe);var Ze=function(){function e(e){if(e===void 0){e=0}this.value=e}return e}();b([s({type:v.Integer})],Ze.prototype,"value",void 0);Ze=b([m({type:p.Choice})],Ze);var Je=function(){function e(e){if(e===void 0){e={}}this.url="";this.language="";Object.assign(this,e)}return e}();b([s({type:v.IA5String})],Je.prototype,"url",void 0);b([s({type:v.PrintableString})],Je.prototype,"language",void 0);Je=b([m({type:p.Sequence})],Je);var $e=Me=function(e){__extends(n,e);function n(n){var a=e.call(this,n)||this;Object.setPrototypeOf(a,Me.prototype);return a}return n}(g);$e=Me=b([m({type:p.Sequence,itemType:Je})],$e);var en=Ye=function(e){__extends(n,e);function n(n){var a=e.call(this,n)||this;Object.setPrototypeOf(a,Ye.prototype);return a}return n}($e);en=Ye=b([m({type:p.Sequence,itemType:Je})],en);var nn=qe=function(e){__extends(n,e);function n(n){var a=e.call(this,n)||this;Object.setPrototypeOf(a,qe.prototype);return a}return n}(g);nn=qe=b([m({type:p.Sequence,itemType:v.ObjectIdentifier})],nn);var an=We=function(e){__extends(n,e);function n(n){var a=e.call(this,n)||this;Object.setPrototypeOf(a,We.prototype);return a}return n}(g);an=We=b([m({type:p.Sequence,itemType:v.PrintableString})],an);var rn="0.4.0.1862.1";var tn="".concat(rn,".3");var un="".concat(rn,".5");var cn="".concat(rn,".6");
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var fn=function(e){var a=e.extension;function r(e,a){if(!a||!a.byteLength){return null}if(e===y){var r=i.parse(a,x);return n(ge,{name:"Semantics Identifier",value:oe(r.semanticsIdentifier)})}if(e===cn){var t=i.parse(a,nn);return n(ge,{name:"QC Types",value:t.map((function(e){return oe(e)})).join(", ")})}if(e===tn){var c=i.parse(a,Ze);return n(ge,{name:"Retention Period",value:"".concat(c.value," years")})}if(e===un){var f=i.parse(a,$e);return[n(ge,{name:"PDS Locations",value:""}),f.map((function(e){return n(me,null,n(ge,{name:"URL",value:e.url}),n(ge,{name:"Language",value:e.language}))}))]}return n(ge,{name:"Info",value:u.Convert.ToHex(a),monospace:true})}return n(De,{extension:a},Boolean(a.value.length)&&[n(ge,{name:"Statements",value:""}),a.value.map((function(e){return n(me,null,n(ge,{name:"Statement ID",value:oe(e.statementId)}),r(e.statementId,e.statementInfo))}))])};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var on=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Comment",value:a.value.value}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var ln=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Type",value:a.value.toJSON().join(", ")}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var dn=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Role",value:a.value.text}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var bn=function(e){var a=e.extension,r=e.getLEILink;return n(De,{extension:a},n(ge,{name:"Identifier",value:a.value.text,href:r(a.value.text)}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var sn=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Version",value:a.value.version}),n(_e,Object.assign({generalName:a.value.location},e)),n(ge,{name:"Requires Auth",value:a.value.requiresAuth?r.getString("yes"):r.getString("no")}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var vn=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Version",value:a.value.version}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var mn=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Reason",value:a.value.toJSON()}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */function pn(e){return u.Convert.ToString(e.values[0])}
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var gn=function(e){var a=e.extension;return n(De,{extension:a},Boolean(a.value.length)&&[n(ge,{name:"Attributes",value:""}),a.value.map((function(e){return n(me,null,n(ge,{name:"Type",value:oe(e.type)}),n(ge,{name:"Value",value:pn(e)}))}))])};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var yn=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Value",value:a.value,monospace:true}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var xn=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Not Before",value:t(a.value.notBefore)}),n(ge,{name:"Not After",value:t(a.value.notAfter)}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var hn=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:"Version",value:a.value.entrustVers}),n(ge,{name:"Info Flags",value:a.value.entrustInfoFlags.toJSON().join(", ")}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var jn=function(e){var a=e.extension;return n(De,{extension:a},a.value.length>0&&[n(ge,{name:"Entries",value:""}),a.value.map((function(e){return n(me,null,n(ge,{name:"SPC",value:e.spc}),n(ge,{name:"Range",value:e.range?"start=".concat(e.range.start," count==").concat(e.range.count):null}),n(ge,{name:"One",value:e.one}))}))])};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var An=function(e){var a=e.extension;return n(De,{extension:a},a.value.length>0&&[n(ge,{name:"Policies",value:""}),a.value.map((function(e){return n(me,null,n(ge,{name:"Issuer Domain",value:oe(e.issuerDomainPolicy)}),n(ge,{name:"Subject Domain",value:oe(e.subjectDomainPolicy)}))}))])};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Dn=function(e){var a=e.extension;return n(De,{extension:a},n(ge,{name:r.getString("value"),value:a.value.value}))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
/**
             ...
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var On=function(e){var a=e.extension;var t=function(e){return Object.keys(e).map((function(a){var c=e[a];var f="";switch(true){case typeof c==="string"||typeof c==="number":f=c;break;case c instanceof j:f=c.join(", ");break;case typeof c==="boolean":f=c?r.getString("yes"):r.getString("no");break;case Object.is(c,null):f="NULL";break;case c instanceof S:return[n(ge,{name:le(a),value:""}),n(me,null,t(c))];case u.BufferSourceConverter.isBufferSource(c):if(a==="attestationApplicationId"){try{var o=i.parse(c,C);if(o.packageInfos.length||o.signatureDigests.length){return[n(ge,{name:le(a),value:""}),Boolean(o.packageInfos)&&n(me,null,n(ge,{name:le("packageInfos"),value:""}),o.packageInfos.map((function(e){return n(me,null,t(e))})))]}}catch(e){}}try{f=u.Convert.ToString(c)}catch(e){f=u.Convert.ToHex(c)}break}return n(ge,{name:le(a),value:f})}))};var c=function(e,a){if(a.length===0){return null}return[n(ge,{name:e,value:""}),n(me,null,a.map(t))]};return n(De,{extension:a},n(ge,{name:le("attestationVersion"),value:a.value.attestationVersion}),n(ge,{name:le("attestationSecurityLevel"),value:a.value.attestationSecurityLevel}),n(ge,{name:le("keymasterVersion"),value:a.value.keymasterVersion}),n(ge,{name:le("keymasterSecurityLevel"),value:a.value.keymasterSecurityLevel}),n(ge,{name:le("attestationChallenge"),value:u.Convert.ToString(a.value.attestationChallenge)}),n(ge,{name:le("uniqueId"),value:u.Convert.ToString(a.value.uniqueId)||undefined}),c(le("softwareEnforced"),a.value.softwareEnforced),c(le("teeEnforced"),a.value.teeEnforced))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Tn=function(e){var a=e.extension;return n(De,{extension:a},Object.keys(a.value).map((function(e){return n(ge,{name:le(e),value:a.value[e]})})))};
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
             * This source code is licensed under the MIT license found in the
             * LICENSE file in the root directory of this source tree.
             */var Gn=e("E",(function(e){var a=e.extensions,r=e.title;if(!a||!a.length){return null}return[n(pe,{value:r||"Extensions"}),a.map((function(a){try{if(a.value instanceof N){return n(Ie,{extension:a})}if(a.value instanceof A){return n(Oe,{extension:a})}if(a.value instanceof D){return n(Te,{extension:a})}if(a.value instanceof I){return n(Ge,Object.assign({extension:a},e))}if(a.value instanceof O){return n(Pe,Object.assign({extension:a},e))}if(a.value instanceof T){return n(ke,Object.assign({extension:a},e))}if(a.value instanceof G||a.value instanceof P){return n(Re,Object.assign({extension:a},e))}if(a.value instanceof V){return n(Ee,Object.assign({extension:a},e))}if(a.value instanceof _){return n(Be,{extension:a})}if(a.value instanceof ue){return n(Ue,{extension:a})}if(a.value instanceof k){return n(we,Object.assign({extension:a},e))}if(a.value instanceof R){return n(He,{extension:a})}if(a.value instanceof E){return n(Xe,{extension:a})}if(a.value instanceof B){return n(Ke,{extension:a})}if(a.value instanceof L){return n(fn,{extension:a})}if(a.value instanceof U){return n(on,{extension:a})}if(a.value instanceof w){return n(ln,{extension:a})}if(a.value instanceof H){return n(dn,{extension:a})}if(a.value instanceof X){return n(bn,Object.assign({extension:a},e))}if(a.value instanceof K){return n(sn,Object.assign({extension:a},e))}if(a.value instanceof M){return n(vn,{extension:a})}if(a.value instanceof Y){return n(mn,{extension:a})}if(a.value instanceof q){return n(gn,{extension:a})}if(a.value instanceof W){return n(xn,{extension:a})}if(a.value instanceof z){return n(hn,{extension:a})}if(a.value instanceof Q){return n(Cn,{extension:a})}if(a.value instanceof F){return n(Sn,{extension:a})}if(a.value instanceof Z){return n(jn,{extension:a})}if(a.value instanceof J){return n(Nn,{extension:a})}if(a.value instanceof $){return n(An,{extension:a})}if(a.value instanceof ee){return n(Dn,{extension:a})}if(a.value instanceof ne){return n(In,Object.assign({extension:a},e))}if(a.value instanceof ae){return n(On,Object.assign({extension:a},e))}if(a.value instanceof re){return n(Tn,Object.assign({extension:a},e))}if(typeof a.value==="string"){return n(yn,{extension:a})}return n(De,{extension:a})}catch(e){console.error("Error render extension:",a.asn.extnID);return null}}))]}));
/**
             * @license
             * Copyright (c) Peculiar Ventures, LLC.
             *
...
//# sourceMappingURL=p-DxP-r3hC.system.js.map