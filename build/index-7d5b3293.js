...
(function (EnumOIDs) {
    ...
    EnumOIDs["SubjectDirectoryAttributes"] = "2.5.29.9";
    EnumOIDs["AdobeTimestamp"] = "1.2.840.113583.1.1.9.1";
    EnumOIDs["LEI"] = "1.3.6.1.4.1.52266.1";
    EnumOIDs["Role"] = "1.3.6.1.4.1.52266.2";
    EnumOIDs["ANY"] = "";
})(EnumOIDs || (EnumOIDs = {}));
        ...
        if (fullDecode) {
            ...
            if (pkijsSchema.extensions) {
                pkijsSchema.extensions.forEach((ext) => {
                    ...
                    if (ext.parsedValue instanceof SubjectDirectoryAttributes) {
                        const extension = {
                            name: OIDs[ext.extnID] || '',
                            critical: ext.critical,
                    ...
                    if (ext.extnID === EnumOIDs.AdobeTimestamp) {
                         ...
                         */
                        const { offset, result } = fromBER(ext.extnValue.valueBlock.valueHex);
                        if (offset === -1) {
                            return;
                        }
                        const extension = {
                            ...
                            value: {
                                version: (_a = result['valueBlock'].value[0]) === null || _a === void 0 ? void 0 : _a.valueBlock.valueDec,
                                location: Convert.ToString((_b = result['valueBlock'].value[1]) === null || _b === void 0 ? void 0 : _b.valueBlock.valueHex),
                                requiresAuth: (_c = result['valueBlock'].value[2]) === null || _c === void 0 ? void 0 : _c.valueBlock.value,
                            },
                        };
                        return this.extensions.push(extension);
                    }
                    ...
                    if ((_e = (_d = ext.parsedValue) === null || _d === void 0 ? void 0 : _d.valueBlock) === null || _e === void 0 ? void 0 : _e.valueHex) {
                    ...
                    else if ((_g = (_f = ext.extnValue) === null || _f === void 0 ? void 0 : _f.valueBlock) === null || _g === void 0 ? void 0 : _g.valueHex) {
                        extension.value = Convert.ToHex(ext
                            .extnValue
                            .valueBlock
                            .valueHex);
