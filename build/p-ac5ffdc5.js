 ...
 */
import{A as t,t as s,u as i,v as e,D as r,w as a,x as n,y as o,z as h,B as c,F as u,G as l,T as E,H as f,I as m,J as g,W as A,K as p,L as d,M as C,V as w,O as x,P as T,Q as R,U as b,S as I,X as v,e as N,Y as y,f as F,E as B,g as D,s as P,q as H,r as S,Z as L,N as X,h as $,j as U,k as j,R as q,_ as G}from"./p-5de20aa9.js";import{C as K,D as M}from"./p-59e5ac12.js";
/**
 * @license
 ...
 */const O={[e]:r,[a]:n,[o]:h,[c]:u,[l]:E,[f]:m,[g]:A,[p]:d,[C]:w,[x]:T,[R]:b,[I]:v};class Q extends t{getAsnExtnValue(){return this.asn.values[0]}constructor(t){super(t,s);const e=this.getAsnExtnValue();try{const t=O[this.asn.type];if(t){this.value=i.parse(e,t)}else{console.warn(`Didn't detect parser for "${this.asn.type}" attribute.`);this.value=K.ToHex(e)}}catch(t){console.error(`Error parse "${this.asn.type}" attribute:`,t.message);this.value=K.ToHex(e)}}}
/**
 * @license
 * Copyright (c) Peculiar Ventures, LLC.
 *
...
//# sourceMappingURL=p-ac5ffdc5.js.map