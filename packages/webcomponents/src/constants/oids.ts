...
export const OIDs = {
  ...
  '1.2.840.113549.1.12.4.1':
    'PKCS-12-x509 Cert CRL Bag I Dformerly assigned as pkcs-12-x509 Cert CRL Bag',
  ...
  '1.2.840.113549.1.12.5.1':
    'PKCS-12-PBEI Dthe partially compatible (128401135491121) OIDs instead',
  ...
  '1.2.840.113549.1.12.5.1.3':
    'PKCS-12-PBE with SHA1 And Triple DESCB Cuse the incompatible but similar (1284011354911213) or (1284011354911214) instead',
  '1.2.840.113549.1.12.5.1.4':
    'PKCS-12-PBE with SHA1 And128 Bit RC2CB Cuse (1284011354911215) instead',
  '1.2.840.113549.1.12.5.1.5':
    'PKCS-12-PBE with SHA1 And40 Bit RC2CB Cuse (1284011354911216) instead',
  '1.2.840.113549.1.12.5.1.6':
    'PKCS-12-PBE with SHA1 And RC4use the incompatible but similar (1284011354911211) or (1284011354911212) instead',
  '1.2.840.113549.1.12.5.1.7':
    'PKCS-12-PBE with SHA1 And RC2CB Cuse the incompatible but similar (1284011354911215) or (1284011354911216) instead',
  '1.2.840.113549.1.12.5.2': 'PKCS-12-Enveloping I Dthe conventional PKCS#1OIDs instead',
  '1.2.840.113549.1.12.5.2.1':
    'PKCS-12-RSA Encryption With128 Bit RC4use the conventional PKCS#1OIDs instead',
  '1.2.840.113549.1.12.5.2.2':
    'PKCS-12-RSA Encryption With40 Bit RC4use the conventional PKCS#1OIDs instead',
  '1.2.840.113549.1.12.5.2.3':
    'PKCS-12-RSA Encryption with Triple DESuse the conventional PKCS#1OIDs instead',
  '1.2.840.113549.1.12.5.3': 'PKCS-12-Signature IDuse the conventional PKCS#1OIDs instead',
  '1.2.840.113549.1.12.5.3.1':
    'PKCS-12-RSA Signature with SHA1 Digestuse the conventional PKCS#1OIDs instead',
  ...
  '1.2.840.113635.100.6.1': 'Apple Extension Code Signing',
  '1.2.840.113635.100.6.1.1': 'Apple Extension Apple Signing',
  '1.2.840.113635.100.6.1.2': 'Apple Extension iPhone Developer',
  '1.2.840.113635.100.6.1.3': 'Apple Extension Apple iPhone OS Application Signing',
  '1.2.840.113635.100.6.1.4': 'Apple Extension Apple Developer Certificate (Submission)',
  '1.2.840.113635.100.6.1.5': 'Apple Extension Safari Developer',
  '1.2.840.113635.100.6.1.6': 'Apple Extension Apple iPhone OS VPN Signing',
  '1.2.840.113635.100.6.1.7': 'Apple Extension Apple Mac App Signing (Development)',
  '1.2.840.113635.100.6.1.8': 'Apple Extension Apple Mac App Signing Submission',
  '1.2.840.113635.100.6.1.9': 'Apple Extension Mac App Store Code Signing',
  '1.2.840.113635.100.6.1.10': 'Apple Extension Mac App Store Installer Signing',
  '1.2.840.113635.100.6.1.12': 'Apple Extension Mac Developer',
  '1.2.840.113635.100.6.1.13': 'Apple Extension Developer ID Application',
  '1.2.840.113635.100.6.1.14': 'Apple Extension Developer ID Installer',
  '1.2.840.113635.100.6.1.16': 'Apple Extension Apple Pay Passbook Signing',
  '1.2.840.113635.100.6.1.17': 'Apple Extension Web Site Push Notifications Signing',
  '1.2.840.113635.100.6.1.18': 'Apple Extension Developer ID Kernel',
  '1.2.840.113635.100.6.1.33': 'Apple Extension Developer ID Date',
  '1.2.840.113635.100.6.1.25.1': 'Apple Extension TestFlight',
  '1.2.840.113635.100.6.2.1': 'Apple Worldwide Developer Relations',
  '1.2.840.113635.100.6.2.3': 'Apple Application Integration',
  '1.2.840.113635.100.6.2.6': 'Developer ID Certification Authority',
  '1.2.840.113635.100.6.2.9': 'Apple Timestamp',
  '1.2.840.113635.100.6.2.11': 'Developer Authentication Certification Authority',
  '1.2.840.113635.100.6.2.14': 'Apple Application Integration CA - G3',
  '1.2.840.113635.100.6.2.15': 'Apple Worldwide Developer Relations CA - G2',
  '1.2.840.113635.100.6.2.19': 'Apple Software Update Certification',
  '1.2.840.113635.100.6.2.31': 'Apple Application Integration CA - G1',
  ...
  '1.3.6.1.4.1.311.21.4': 'Microsoft CRL Next Publish',
  ...
  '2.16.840.1.101.3.6.9.1':
    'Personal Identity Verification (PIV) National Agency Check with Inquiries (NACI) indicator',
