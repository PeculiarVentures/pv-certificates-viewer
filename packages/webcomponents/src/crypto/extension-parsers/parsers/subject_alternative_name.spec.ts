...
describe('SubjectAlternativeNameParser', () => {
  ...
  it('parses email (rfc822Name)', () => {
    ...
    expect(
      parser.parse(makeExtRaw(id_ce_subjectAltName, '3012811075736572406578616d706c652e636f6d')),
    ).toEqual({
      oid: '2.5.29.17',
      critical: false,
      children: [
  ...
  it('parses IP address', () => {
    ...
    expect(parser.parse(makeExtRaw(id_ce_subjectAltName, '30068704c0000201'))).toEqual({
      oid: '2.5.29.17',
      critical: false,
      children: [
        {
