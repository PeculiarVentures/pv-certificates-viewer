...
const ANDROID_KEY_DESCRIPTION_HEX =
    ...
    expect(parser.parse(makeExtRaw(id_ce_keyDescription, ANDROID_KEY_DESCRIPTION_HEX))).toEqual({
      ...
      children: [
        ...
        },
        {
          ...
          value: 'trustedEnvironment',
        },
        {
          title: 'Keymaster Version',
          value: 100,
        },
        {
          title: 'Keymaster Security Level',
          value: 'trustedEnvironment',
        },
        {
          title: 'Attestation Challenge',
          value: '1b1ada35ac426eb1f845c87ee29f0ec3',
        },
        {
                  ...
                  children: [
                    {
                      ...
                      children: [
                        {
                          title: 'Package Name',
                          value: 'com.tickpickllc.ceobrien.tickpick',
                        },
                        {
                          title: 'Version',
                          value: 297,
        ...
        },
        {
          ...
          children: [
            ...
            {
              title: 'Attestation Id Model',
              value: 'motorola edge (2022)',
            },
            {
              title: 'Attestation Id Manufacturer',
              value: 'motorola',
            },
            {
              title: 'Attestation Id Product',
              value: 'tesla_g_sys',
            },
            {
              title: 'Attestation Id Device',
              value: 'tesla',
            },
            {
              title: 'Attestation Id Brand',
              value: 'motorola',
            },
            {
              title: 'Vendor Patch Level',
              value: '20230801',
            },
            {
              title: 'Boot Patch Level',
              value: '20230801',
            },
          ],
        },
