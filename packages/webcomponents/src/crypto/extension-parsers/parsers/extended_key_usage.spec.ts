import { id_ce_extKeyUsage } from '@peculiar/asn1-x509';
...
describe('ExtendedKeyUsageParser', () => {
  ...
  it('parses serverAuth and clientAuth', () => {
    ...
    expect(
      parser.parse(makeExtRaw(id_ce_extKeyUsage, '301406082b0601050507030106082b06010505070302')),
    ).toEqual({
      oid: '2.5.29.37',
      critical: false,
      children: [
  ...
  it('parses an unknown key purpose OID', () => {
    ...
    expect(parser.parse(makeExtRaw(id_ce_extKeyUsage, '300606042a030405'))).toEqual({
      oid: '2.5.29.37',
      critical: false,
      children: [
        {
