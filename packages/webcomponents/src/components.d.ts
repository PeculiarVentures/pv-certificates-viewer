...
declare global {
  interface HTMLPeculiarAttributeCertificateViewerElement
    extends Components.PeculiarAttributeCertificateViewer, HTMLStencilElement {}
  ...
  interface HTMLPeculiarButtonMenuElement
    extends Components.PeculiarButtonMenu, HTMLStencilElement {}
  var HTMLPeculiarButtonMenuElement: {
    prototype: HTMLPeculiarButtonMenuElement;
    new (): HTMLPeculiarButtonMenuElement;
  };
  interface HTMLPeculiarCertificateChainViewerElement
    extends Components.PeculiarCertificateChainViewer, HTMLStencilElement {}
  ...
  interface HTMLPeculiarCertificateDecoderElement
    extends Components.PeculiarCertificateDecoder, HTMLStencilElement {
    addEventListener<K extends keyof HTMLPeculiarCertificateDecoderElementEventMap>(
      type: K,
      listener: (
        this: HTMLPeculiarCertificateDecoderElement,
        ev: PeculiarCertificateDecoderCustomEvent<HTMLPeculiarCertificateDecoderElementEventMap[K]>,
      ) => any,
    ...
    removeEventListener<K extends keyof HTMLPeculiarCertificateDecoderElementEventMap>(
      type: K,
      listener: (
        this: HTMLPeculiarCertificateDecoderElement,
        ev: PeculiarCertificateDecoderCustomEvent<HTMLPeculiarCertificateDecoderElementEventMap[K]>,
  ...
  interface HTMLPeculiarCertificateViewerElement
    extends Components.PeculiarCertificateViewer, HTMLStencilElement {}
  ...
  interface HTMLPeculiarCertificatesViewerElement
    extends Components.PeculiarCertificatesViewer, HTMLStencilElement {
    addEventListener<K extends keyof HTMLPeculiarCertificatesViewerElementEventMap>(
      type: K,
      listener: (
        this: HTMLPeculiarCertificatesViewerElement,
        ev: PeculiarCertificatesViewerCustomEvent<HTMLPeculiarCertificatesViewerElementEventMap[K]>,
      ) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLPeculiarCertificatesViewerElementEventMap>(
      type: K,
      listener: (
        this: HTMLPeculiarCertificatesViewerElement,
        ev: PeculiarCertificatesViewerCustomEvent<HTMLPeculiarCertificatesViewerElementEventMap[K]>,
  ...
  interface HTMLPeculiarCircularProgressElement
    extends Components.PeculiarCircularProgress, HTMLStencilElement {}
  ...
  interface HTMLPeculiarHighlightWordsElement
    extends Components.PeculiarHighlightWords, HTMLStencilElement {}
  var HTMLPeculiarHighlightWordsElement: {
    prototype: HTMLPeculiarHighlightWordsElement;
    new (): HTMLPeculiarHighlightWordsElement;
  };
  interface HTMLPeculiarSshCertificateViewerElement
    extends Components.PeculiarSshCertificateViewer, HTMLStencilElement {}
  ...
  export namespace JSX {
    interface IntrinsicElements {
      'peculiar-attribute-certificate-viewer': LocalJSX.PeculiarAttributeCertificateViewer &
        JSXBase.HTMLAttributes<HTMLPeculiarAttributeCertificateViewerElement>;
      'peculiar-button-menu': LocalJSX.PeculiarButtonMenu &
        JSXBase.HTMLAttributes<HTMLPeculiarButtonMenuElement>;
      'peculiar-certificate-chain-viewer': LocalJSX.PeculiarCertificateChainViewer &
        JSXBase.HTMLAttributes<HTMLPeculiarCertificateChainViewerElement>;
      'peculiar-certificate-decoder': LocalJSX.PeculiarCertificateDecoder &
        JSXBase.HTMLAttributes<HTMLPeculiarCertificateDecoderElement>;
      'peculiar-certificate-viewer': LocalJSX.PeculiarCertificateViewer &
        JSXBase.HTMLAttributes<HTMLPeculiarCertificateViewerElement>;
      'peculiar-certificates-viewer': LocalJSX.PeculiarCertificatesViewer &
        JSXBase.HTMLAttributes<HTMLPeculiarCertificatesViewerElement>;
      'peculiar-circular-progress': LocalJSX.PeculiarCircularProgress &
        JSXBase.HTMLAttributes<HTMLPeculiarCircularProgressElement>;
      'peculiar-crl-viewer': LocalJSX.PeculiarCrlViewer &
        JSXBase.HTMLAttributes<HTMLPeculiarCrlViewerElement>;
      'peculiar-csr-viewer': LocalJSX.PeculiarCsrViewer &
        JSXBase.HTMLAttributes<HTMLPeculiarCsrViewerElement>;
      'peculiar-highlight-words': LocalJSX.PeculiarHighlightWords &
        JSXBase.HTMLAttributes<HTMLPeculiarHighlightWordsElement>;
      'peculiar-ssh-certificate-viewer': LocalJSX.PeculiarSshCertificateViewer &
        JSXBase.HTMLAttributes<HTMLPeculiarSshCertificateViewerElement>;
      'peculiar-text-hider': LocalJSX.PeculiarTextHider &
        JSXBase.HTMLAttributes<HTMLPeculiarTextHiderElement>;
    }
  }
}
