...
export const PeculiarAttributeCertificateViewer = /*@__PURE__*/ createReactComponent<
  JSX.PeculiarAttributeCertificateViewer,
  HTMLPeculiarAttributeCertificateViewerElement
>(
  'peculiar-attribute-certificate-viewer',
  undefined,
  undefined,
  definePeculiarAttributeCertificateViewer,
);
export const PeculiarCertificateViewer = /*@__PURE__*/ createReactComponent<
  JSX.PeculiarCertificateViewer,
  HTMLPeculiarCertificateViewerElement
>('peculiar-certificate-viewer', undefined, undefined, definePeculiarCertificateViewer);
export const PeculiarCertificatesViewer = /*@__PURE__*/ createReactComponent<
  JSX.PeculiarCertificatesViewer,
  HTMLPeculiarCertificatesViewerElement
>('peculiar-certificates-viewer', undefined, undefined, definePeculiarCertificatesViewer);
export const PeculiarCrlViewer = /*@__PURE__*/ createReactComponent<
  JSX.PeculiarCrlViewer,
  HTMLPeculiarCrlViewerElement
>('peculiar-crl-viewer', undefined, undefined, definePeculiarCrlViewer);
export const PeculiarCsrViewer = /*@__PURE__*/ createReactComponent<
  JSX.PeculiarCsrViewer,
  HTMLPeculiarCsrViewerElement
>('peculiar-csr-viewer', undefined, undefined, definePeculiarCsrViewer);
export const PeculiarSshCertificateViewer = /*@__PURE__*/ createReactComponent<
  JSX.PeculiarSshCertificateViewer,
  HTMLPeculiarSshCertificateViewerElement
>('peculiar-ssh-certificate-viewer', undefined, undefined, definePeculiarSshCertificateViewer);
